# 0 "cylindernewtest-cpp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "cylindernewtest-cpp.c"
@if 700 < 700
  @undef 700
  @define 700 700
@endif
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  if (!(2 == 2)) qassert ("./../ibm-utils.h", 0, "dimension == 2");
...
void printxx (Point point, coord * mC, coord * bC, coord * dudn)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
...
#line 204
{
    ...
    fprintf (ferr, "|| x=%g y=%g mC.x=%g mC.y=%g bC.x=%g bC.y=%g dudn.x=%g dudn.y=%g\n",
...
vector  faceForce={{14},{15}};

static int acceleration_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++)!=0;*ip=i;*tp=t;return ret;}


#line 21
      static int acceleration_0(const int i,const double t,Event *_ev){tracing("acceleration_0","./../immersed-new.h",0);
{
...
#line 27
foreach_stencil(1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"alpha","vector",(void *)&alpha,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"u","vector",(void *)&u,NULL,0},{"utemp","vector",(void *)&utemp,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n        \n// #line 28 \"./../immersed-new.h\"\n{\n            val_out_(utemp.x,0,0,0) = val(u.x,0,0,0) - dt*(val(alpha.x,0,0,0)*(val(p,0,0,0) - val(p,-1,0,0))/Delta);\n            \n// #line 29\nval_out_(utemp.y,0,0,0) = val(u.y,0,0,0) - dt*(val(alpha.y,0,0,0)*(val(p,0,0,0) - val(p,0,-1,0))/Delta);}")})
        {
            { _stencil_val(u.x,0,0,0);_stencil_val(alpha.x,0,0,0);_stencil_val(p,0,0,0); _stencil_val(p,-1,0,0);_stencil_val_a(utemp.x,0,0,0);    }
            
#line 29
{ _stencil_val(u.y,0,0,0);_stencil_val(alpha.y,0,0,0);_stencil_val(p,0,0,0); _stencil_val(p,0,-1,0);_stencil_val_a(utemp.y,0,0,0);    }}end_foreach_stencil();{
#line 27
foreach()
        {
            val(utemp.x,0,0,0) = val(u.x,0,0,0) - dt*(val(alpha.x,0,0,0)*(val(p,0,0,0) - val(p,-1,0,0))/Delta);
            
#line 29
val(utemp.y,0,0,0) = val(u.y,0,0,0) - dt*(val(alpha.y,0,0,0)*(val(p,0,0,0) - val(p,0,-1,0))/Delta);}end_foreach();}}else {_coord _const_alpha={_constant[alpha.x.i-_NVARMAX],_constant[alpha.y.i-_NVARMAX]};NOT_UNUSED(_const_alpha);
    
#line 27
foreach_stencil(1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"_const_alpha","_coord",(void *)&_const_alpha,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"u","vector",(void *)&u,NULL,0},{"utemp","vector",(void *)&utemp,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n        \n// #line 28 \"./../immersed-new.h\"\n{\n            val_out_(utemp.x,0,0,0) = val(u.x,0,0,0) - dt*(_const_alpha.x*(val(p,0,0,0) - val(p,-1,0,0))/Delta);\n            \n// #line 29\nval_out_(utemp.y,0,0,0) = val(u.y,0,0,0) - dt*(_const_alpha.y*(val(p,0,0,0) - val(p,0,-1,0))/Delta);}")})
        {
            { _stencil_val(u.x,0,0,0);;_stencil_val(p,0,0,0); _stencil_val(p,-1,0,0);_stencil_val_a(utemp.x,0,0,0);    }
            
#line 29
{ _stencil_val(u.y,0,0,0);;_stencil_val(p,0,0,0); _stencil_val(p,0,-1,0);_stencil_val_a(utemp.y,0,0,0);    }}end_foreach_stencil();
    {
#line 27
foreach()
        {
            val(utemp.x,0,0,0) = val(u.x,0,0,0) - dt*(_const_alpha.x*(val(p,0,0,0) - val(p,-1,0,0))/Delta);
            
#line 29
val(utemp.y,0,0,0) = val(u.y,0,0,0) - dt*(_const_alpha.y*(val(p,0,0,0) - val(p,0,-1,0))/Delta);}end_foreach();}}
...
#line 98
foreach_face_stencil(1,{(NonLocal[]){{"cellForce","vector",(void *)&cellForce,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"faceForce","vector",(void *)&faceForce,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 98 \"./../immersed-new.h\"\n{is_face_x(){\n        val_out_(faceForce.x,0,0,0) = val(fm.x,0,0,0)*(((val(cellForce.x,0,0,0) + val(cellForce.x,0 -1,0,0))/2.));}end_is_face_x()\n// #line 98\nis_face_y(){\n        val_out_(faceForce.y,0,0,0) = val(fm.y,0,0,0)*(((val(cellForce.y,0,0,0) + val(cellForce.y,0,0 -1,0))/2.));}end_is_face_y()}")}){_stencil_is_face_x(){
...
#line 98
foreach_face_stencil(1,{(NonLocal[]){{"cellForce","vector",(void *)&cellForce,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"faceForce","vector",(void *)&faceForce,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 98 \"./../immersed-new.h\"\n{is_face_x(){\n        val_out_(faceForce.x,0,0,0) = _const_fm.x*(((val(cellForce.x,0,0,0) + val(cellForce.x,0 -1,0,0))/2.));}end_is_face_x()\n// #line 98\nis_face_y(){\n        val_out_(faceForce.y,0,0,0) = _const_fm.y*(((val(cellForce.y,0,0,0) + val(cellForce.y,0,0 -1,0))/2.));}end_is_face_y()}")}){_stencil_is_face_x(){
...
is_face_y(){
    ...
    a = faceForce;delete((scalar*)((vector[]){utemp,{{-1},{-1}}}));
# 110 "./../immersed-new.h"
}{end_tracing("acceleration_0","./../immersed-new.h",0);return 0;}end_tracing("acceleration_0","./../immersed-new.h",0);}
...
#line 116
      static int end_timestep_0(const int i,const double t,Event *_ev){tracing("end_timestep_0","./../immersed-new.h",0);
{
    coord desiredVelocity;
    trash(a);
    centered_gradient (p, g);
    foreach_stencil(1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"desiredVelocity","coord",(void *)&desiredVelocity,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n        \n// #line 122 \"./../immersed-new.h\"\nif (val(vof,0,0,0) >= 0.5) {\n// # 133 \"./../immersed-new.h\"\n            desiredVelocity = vc;\n\n            \n                val_out_(u.x,0,0,0) = desiredVelocity.x - (1 - val(vof,0,0,0))*fabs((val(u.x,0,0,0)));\n                \n// #line 136\nval_out_(u.y,0,0,0) = desiredVelocity.y - (1 - val(vof,0,0,0))*fabs((val(u.y,0,0,0)));\n        }")})
        {_stencil_val(vof,0,0,0); { 
# 133 "./../immersed-new.h"
             

            
                { _stencil_val(vof,0,0,0);_stencil_val(u.x,0,0,0);_stencil_val_a(u.x,0,0,0);     }
                
#line 136
{ _stencil_val(vof,0,0,0);_stencil_val(u.y,0,0,0);_stencil_val_a(u.y,0,0,0);     }
        }   }end_foreach_stencil();
    {
#line 121
foreach()
...
# 133 "./../immersed-new.h"
            desiredVelocity = vc;
                ...
                val(u.x,0,0,0) = desiredVelocity.x - (1 - val(vof,0,0,0))*fabs((val(u.x,0,0,0)));
                
#line 136
val(u.y,0,0,0) = desiredVelocity.y - (1 - val(vof,0,0,0))*fabs((val(u.y,0,0,0)));
        }end_foreach();}
}{end_tracing("end_timestep_0","./../immersed-new.h",0);return 0;}end_tracing("end_timestep_0","./../immersed-new.h",0);}
...
# 3 "cylindernewtest.c" 2
# 1 "view.h" 1
# 4 "cylindernewtest.c" 2
...
#line 72
      static int moving_cylinder(const int i,const double t,Event *_ev){tracing("moving_cylinder","cylindernewtest.c",0); {
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 73 \"cylindernewtest.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);")}) {_stencil_val_a(phi,0,0,0);           }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);end_foreach_vertex();} fractions (phi, vof, sf
#line 122 "/home/spencer/basilisk/src/fractions.h"
, 0.
#line 73 "cylindernewtest.c"
);delete((scalar*)((scalar[]){phi,{-1}})); } while(0);
}{end_tracing("moving_cylinder","cylindernewtest.c",0);return 0;}end_tracing("moving_cylinder","cylindernewtest.c",0);}
...
#line 77
      static int properties_0(const int i,const double t,Event *_ev){tracing("properties_0","cylindernewtest.c",0); {
  if(!is_constant(fm.x)){
  
#line 78
foreach_face_stencil(1,{(NonLocal[]){{"Re","int",(void *)&Re,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 78 \"cylindernewtest.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(0.5)/(Re);}end_is_face_x()\n// #line 78\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(0.5)/(Re);}end_is_face_y()}")}){_stencil_is_face_x(){
...
#line 78
foreach_face_stencil(1,{(NonLocal[]){{"Re","int",(void *)&Re,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 78 \"cylindernewtest.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(0.5)/(Re);}end_is_face_x()\n// #line 78\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(0.5)/(Re);}end_is_face_y()}")}){_stencil_is_face_x(){
...
is_face_y(){
   ...
   boundary_internal ((scalar *)(scalar *)((vector[]) {muv,{{-1},{-1}}}), "cylindernewtest.c", 0);
}{end_tracing("properties_0","cylindernewtest.c",0);return 0;}end_tracing("properties_0","cylindernewtest.c",0);}
...
#line 87
      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","cylindernewtest.c",0);{
  coord Fp, Fmu;
...
}{end_tracing("logfile","cylindernewtest.c",0);return 0;}end_tracing("logfile","cylindernewtest.c",0);}
...
#line 103
      static int profile(const int i,const double t,Event *_ev){tracing("profile","cylindernewtest.c",0); {
  int k = 0;
  double delta = 20/(pow(2,11));
  char name[80];

  sprintf (name, "vprofx1-%d", Re);
  FILE * fv = fopen(name, "w");
  for(double i = 0; i <= 20; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"u","vector",(void *)&u,NULL,0},{"fv","not implemented yet",(void *)fv,NULL,1},{"k","int",(void *)&k,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 111 \"cylindernewtest.c\"\n{\n      if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1)\n        k = 2.;\n      else if (val(vof,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv, \"%d %g %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0), val(p,0,0,0));\n    }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ 
...
foreach_point (4.8125, i) {
 ...
 k = 0.;
  ...
  for(double i = 0; i <= 20; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"u","vector",(void *)&u,NULL,0},{"fv1","not implemented yet",(void *)fv1,NULL,1},{"k","int",(void *)&k,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 127 \"cylindernewtest.c\"\n{\n      if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1)\n        k = 2.;\n      else if (val(vof,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv1, \"%d %g %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0), val(p,0,0,0));\n    }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ 
...
foreach_point (5, i) {
 ...
 k = 0.;
  ...
  for(double i = 0; i <= 20; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"u","vector",(void *)&u,NULL,0},{"fv2","not implemented yet",(void *)fv2,NULL,1},{"k","int",(void *)&k,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 143 \"cylindernewtest.c\"\n{\n      if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1)\n        k = 2.;\n      else if (val(vof,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv2, \"%d %g %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0), val(p,0,0,0));\n    }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ 
...
foreach_point (10, i) {
 ...
 k = 0.;
  ...
  for(double i = 0; i <= 20; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"u","vector",(void *)&u,NULL,0},{"fv3","not implemented yet",(void *)fv3,NULL,1},{"k","int",(void *)&k,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 159 \"cylindernewtest.c\"\n{\n      if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1)\n        k = 2.;\n      else if (val(vof,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv3, \"%d %g %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0), val(p,0,0,0));\n    }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ 
...
foreach_point (i, ci.y) {
 ...
 k = 0.;
  ...
  for(double i = 0; i <= 20; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"p","scalar",(void *)&p,NULL,0},{"u","vector",(void *)&u,NULL,0},{"fv4","not implemented yet",(void *)fv4,NULL,1},{"k","int",(void *)&k,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"delta","double",(void *)&delta,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 175 \"cylindernewtest.c\"\n{\n      if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1)\n        k = 2.;\n      else if (val(vof,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv4, \"%d %g %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0), val(p,0,0,0));\n    }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ 
...
pc.y = m.y + pc.y*Delta;
  ...
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"vc","coord",(void *)&vc,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 214 \"cylindernewtest.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x - vc.x) - sq(y - ci.y - vc.y) + sq(0.51758/2);")}) {_stencil_val_a(phi,0,0,0);               }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x - vc.x) - sq(y - ci.y - vc.y) + sq(0.51758/2);end_foreach_vertex();} fractions (phi, boundaryVelocity
...
}{end_tracing("profile","cylindernewtest.c",0);return 0;}end_tracing("profile","cylindernewtest.c",0);}
...
#line 238
      static int snapshot(const int i,const double t,Event *_ev){tracing("snapshot","cylindernewtest.c",0); {
...
,( float[3]) {0}, 1.
#line 271 "cylindernewtest.c"
);
  squares ("u.x"
#line 1221 "/home/spencer/basilisk/src/draw.h"
, 
NULL
#line 272 "cylindernewtest.c"
, -0.5, 1
#line 1223 "/home/spencer/basilisk/src/draw.h"
, 0, 
false
...
}{end_tracing("snapshot","cylindernewtest.c",0);return 0;}end_tracing("snapshot","cylindernewtest.c",0);}
...
#line 291
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","cylindernewtest.c",0); {
  adapt_wavelet (
#line 292 "/home/spencer/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 292
...
}{end_tracing("frequency","cylindernewtest.c",0);return 0;}end_tracing("frequency","cylindernewtest.c",0);}

static int dump_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 20)!=0;*ip=i;*tp=t;return ret;}


#line 317
      static int dump_0(const int i,const double t,Event *_ev){tracing("dump_0","cylindernewtest.c",0); {
  char name[80];
...
}{end_tracing("dump_0","cylindernewtest.c",0);return 0;}end_tracing("dump_0","cylindernewtest.c",0);}
#line 343
static int stop_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = t_end)!=0;*ip=i;*tp=t;return ret;}
# 343 "cylindernewtest.c"
      static int stop(const int i,const double t,Event *_ev){tracing("stop","cylindernewtest.c",0); {
  static FILE * fp =NULL;if(!fp||i==0)fp=pid()>0?fopen("/dev/null","w"): fopen("perf", "w");
  timing s = timer_timing (perf.gt, iter, perf.tnc, NULL);
  fprintf (fp, "%d\t%g\t%d\t%g\n", Re, s.real, i, s.speed);
  fflush (fp);
  {end_tracing("stop","cylindernewtest.c",0);return 1;}
}{end_tracing("stop","cylindernewtest.c",0);return 0;}end_tracing("stop","cylindernewtest.c",0);}
# 2 "ast/init_solver.h"
...
#line 72 "cylindernewtest.c"
event_register((Event){0,1,moving_cylinder,{moving_cylinder_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"moving_cylinder"});  
#line 87
event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"logfile"});  
#line 103
event_register((Event){0,1,profile,{profile_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"profile"});  
#line 238
event_register((Event){0,1,snapshot,{snapshot_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"snapshot"});  
#line 297
event_register((Event){0,1,frequency,{frequency_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"frequency"});  
#line 317
event_register((Event){0,1,dump_0,{dump_0_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"dump"});  
#line 343
event_register((Event){0,1,stop,{stop_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"stop"});
...
event_register((Event){0,1,vof_0,{vof_0_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/navier-stokes/centered.h",0,"vof"});  
...
#line 21 "./../immersed-new.h"
event_register((Event){0,1,acceleration_0,{acceleration_0_expr0},((int *)0),((double *)0),"./../immersed-new.h",0,"acceleration"});  
#line 116
event_register((Event){0,1,end_timestep_0,{end_timestep_0_expr0},((int *)0),((double *)0),"./../immersed-new.h",0,"end_timestep"});  
#line 77 "cylindernewtest.c"
event_register((Event){0,1,properties_0,{properties_0_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"properties"});  
#line 291
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"cylindernewtest.c",0,"adapt"});

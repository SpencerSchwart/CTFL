#line 0 "pitching-cpp.c"
#line 0 "<built-in>"
#line 0 "<command-line>"
#line 1 "/usr/include/stdc-predef.h"
#line 0 "<command-line>"
#line 1 "pitching-cpp.c"
#if 700 < 700
  #undef 700
  #define 700 700
#endif
...
#line 42
      static int defaults_0(const int i,const double t,Event *_ev){tracing("defaults_0","/home/spencer/basilisk/src/run.h",0); {
  display ("box();"
#line 1425 "/home/spencer/basilisk/src/common.h"
, false
#line 43 "/home/spencer/basilisk/src/run.h"
);
}{end_tracing("defaults_0","/home/spencer/basilisk/src/run.h",0);return 0;}end_tracing("defaults_0","/home/spencer/basilisk/src/run.h",0);}
...
#line 126 "/home/spencer/basilisk/src/navier-stokes/centered.h"
      static int defaults_1(const int i,const double t,Event *_ev){tracing("defaults_1","/home/spencer/basilisk/src/navier-stokes/centered.h",0);
{
...
}{end_tracing("defaults_1","/home/spencer/basilisk/src/navier-stokes/centered.h",0);return 0;}end_tracing("defaults_1","/home/spencer/basilisk/src/navier-stokes/centered.h",0);}
...
#line 74
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}"," \n// #line 74 \"./../immersed.h\"\n{\n    coord nv;\n\n    coord n = facet_normal (point, c, fc), p;\n    real alpha = line_alpha (val(c,0,0,0), n);\n\n\n    real area = val(c,0,0,0)*pow(Delta,2);\n    \n      Fi.x += - val(fm.x,0,0,0)*(val(aF.x,0,0,0))*area;\n      \n// #line 83\nFi.y += - val(fm.y,0,0,0)*(val(aF.y,0,0,0))*area;\n   }"}) {    
    

     _stencil_facet_normal (point, c, fc);     
    _stencil_val(c,0,0,0);  
...
foreach() {
    ...
    double area = val(c,0,0,0)*pow(Delta,2);
...
#line 74
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}"," \n// #line 74 \"./../immersed.h\"\n{\n    coord nv;\n\n    coord n = facet_normal (point, c, fc), p;\n    real alpha = line_alpha (val(c,0,0,0), n);\n\n\n    real area = val(c,0,0,0)*pow(Delta,2);\n    \n      Fi.x += - _const_fm.x*(val(aF.x,0,0,0))*area;\n      \n// #line 83\nFi.y += - _const_fm.y*(val(aF.y,0,0,0))*area;\n   }"}) {    
...
foreach() {
  ...
  boundary_internal ((scalar *)((scalar[]){phi,{-1}}), "./../interfaceforce.h", 0);
  fractions (phi, ink
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  if (!(2 == 2)) qassert ("./../interfaceforce.h", 0, "dimension == 2");
  int i = sign(p.x), j = sign(p.y);
...
#line 57 "pitching.c"
void airfoil_shape (scalar c, vector f, double theta)
{
  double yt, yc = 0;
  ...
  foreach_vertex_stencil(1,{(NonLocal[]){{"mm","double",(void *)&mm,NULL,0},{"yc","double",(void *)&yc,NULL,0},{"pp","double",(void *)&pp,NULL,0},{"yt","double",(void *)&yt,NULL,0},{"chord","double",(void *)&chord,NULL,0},{"rr","double",(void *)&rr,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"theta","double",(void *)&theta,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"cr","coord",(void *)&cr,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 64 \"pitching.c\"\n{\n\n    real XX = cr.x + (x - ci.x)*cos (theta) - (y - ci.y)*sin (theta);\n    real YY = cr.y + (x - ci.x)*sin (theta) + (y - ci.y)*cos (theta);\n\n    if (XX < 0) {\n\n      val_out_(phi,0,0,0) = - sq(XX-rr) - sq(YY) + sq(rr);\n    }\n    else if (XX >= 0. && XX <= chord) {\n\n      yt = (5 * 0.15 * ((0.2969*(sqrt(XX))) -(0.1260*XX) -(0.3516*(sq(XX))) +(0.2843*(cube(XX))) -(0.1036*(pow(XX, 4.)))));\n      if (XX < pp*chord) {\n\n yc = (mm/sq(pp))*((2*pp*XX) - sq(XX));\n      }\n      else {\n\n        yc = (mm/sq(1-pp))*((1-(2*pp))+(2*pp*XX)-sq(XX));\n        }\n      val_out_(phi,0,0,0) = YY > yc? - sq(YY) + sq(yc + yt): - sq(YY) + sq(yc - yt);\n    }\n    else\n      val_out_(phi,0,0,0) = -1.;\n  }"}) {                          
...
foreach_vertex() {
    ...
    if (XX < 0) {
      ...
      val(phi,0,0,0) = - sq(XX-rr) - sq(YY) + sq(rr);
    }
    else if (XX >= 0. && XX <= chord) {
 ...
 yc = (mm/sq(pp))*((2*pp*XX) - sq(XX));
      ...
      val(phi,0,0,0) = YY > yc? - sq(YY) + sq(yc + yt): - sq(YY) + sq(yc - yt);
    }
    else
      val(phi,0,0,0) = -1.;
  }end_foreach_vertex();}
  boundary_internal ((scalar *)((scalar[]){phi,{-1}}), "pitching.c", 0);
  fractions (phi, c, f
...
#line 91 "pitching.c"
  ...
  _attribute[c.i].refine = _attribute[c.i].prolongation = fraction_refine;delete((scalar*)((scalar[]){phi,{-1}}));
}
...
double SDF (double xx, double yy, double theta_p) {
  ...
  if (XX < 0) {
      ...
      double yt = (5 * 0.15 * ((0.2969*(sqrt(XX))) -(0.1260*XX) -(0.3516*(sq(XX))) +(0.2843*(cube(XX))) -(0.1036*(pow(XX, 4.)))));
...
#line 127
      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","pitching.c",0); {

  astats ss;
  int ic = 0;
  do {
    ic++;
    airfoil_shape (airfoil, sf, theta_i*3.14159265358979/180);
    ss = adapt_wavelet (
#line 134 "/home/spencer/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 134
...
#line 134 "pitching.c"
((scalar[]){airfoil,{-1}}), (double[]) {1.e-30}
, 12, (1)
...
#line 135 "pitching.c"
  ...
  airfoil_shape(airfoil, sf, theta_i*3.14159265358979/180);
}{end_tracing("init_0","pitching.c",0);return 0;}end_tracing("init_0","pitching.c",0);}
...
#line 146
      static int moving_cylinder(const int i,const double t,Event *_ev){tracing("moving_cylinder","pitching.c",0); {
  double omega = p_w0*(1- exp(-4.6*t/t_0));
  theta_p = t >= p_ts?omega + theta_i: theta_i;
  theta_p *= 3.14159265358979/180;
  airfoil_shape (airfoil, sf, theta_p);
  airfoil_shape (ref, rf, theta_p);
#line 170 "pitching.c"
}{end_tracing("moving_cylinder","pitching.c",0);return 0;}end_tracing("moving_cylinder","pitching.c",0);}
...
#line 173
      static int properties_0(const int i,const double t,Event *_ev){tracing("properties_0","pitching.c",0); {
  if(!is_constant(fm.x)){
  
#line 174
foreach_face_stencil(1,{(NonLocal[]){{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 174 \"pitching.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(1)/((10000.));}end_is_face_x()\n// #line 174\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(1)/((10000.));}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 174
foreach_face_generic(){is_face_x(){
    val(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(1)/((10000.));}end_is_face_x()
#line 174
is_face_y(){
    val(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(1)/((10000.));}end_is_face_y()}end_foreach_face_generic();}}else {_coord _const_fm={_constant[fm.x.i-_NVARMAX],_constant[fm.y.i-_NVARMAX]};NOT_UNUSED(_const_fm);
  
#line 174
foreach_face_stencil(1,{(NonLocal[]){{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 174 \"pitching.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(1)/((10000.));}end_is_face_x()\n// #line 174\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(1)/((10000.));}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 174
foreach_face_generic(){is_face_x(){
    val(muv.x,0,0,0) = _const_fm.x*(U0)*(1)/((10000.));}end_is_face_x()
#line 174
is_face_y(){
    val(muv.y,0,0,0) = _const_fm.y*(U0)*(1)/((10000.));}end_is_face_y()}end_foreach_face_generic();}}
  boundary_internal ((scalar *)(scalar *)((vector[]) {muv,{{-1},{-1}}}), "pitching.c", 0);
}{end_tracing("properties_0","pitching.c",0);return 0;}end_tracing("properties_0","pitching.c",0);}
...
#line 180
      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","pitching.c",0); {

  coord Fp, Fmu;
  interface_force (airfoil, p, u, mu, &Fp, &Fmu);
  double CD = (Fp.x + Fmu.x)/(0.5*sq(U0)*(1));
  double CL = (Fp.y + Fmu.y)/(0.5*sq(U0)*(1));

  double E = 0;
  double E_p = 0;
  boundary_internal ((scalar *)((scalar[]){u.x, u.y,{-1}}), "pitching.c", 0);
  scalar  omega=new_scalar("omega");
  vorticity (u , omega);
  if(!is_constant(cm)){
  
#line 192
foreach_stencil(1,{(NonLocal[]){{"E","double",(void *)&E,NULL,0},{"u","vector",(void *)&u,NULL,0},{"cs","scalar",(void *)&cs,NULL,0},{"fs","vector",(void *)&fs,NULL,0},{"val","double",(void *)&val,NULL,0},{"embed","bid",(void *)&embed,NULL,0},{"sf","vector",(void *)&sf,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"E_p","double",(void *)&E_p,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"omega","scalar",(void *)&omega,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 375 \"/home/spencer/basilisk/src/embed.h\"\nstatic inline real dirichlet_gradient_y (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.y = - n.y;\n    \n// #line 380\nn.x = - n.x;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(fs.y,0,(n.y > 0.),0))\n      defined = false;\n    \n// #line 384\nif (defined && !val(fs.x,(n.x > 0.),0,0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.y);\n      d[l] = (i - p.y)/n.y;\n      real y1 = p.x + d[l]*n.x;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(fs.y,j,i + (i < 0),0) && val(fs.x,j,i,0) && val(fs.x,j+1,i,0) &&\n   val(cs,j-1,i,0) && val(cs,j,i,0) && val(cs,j+1,i,0))\n v[l] = ((((val(s,j-1,i,0)))*((y1) - 1.) + ((val(s,j+1,i,0)))*((y1) + 1.))*(y1)/2. - ((val(s,j,i,0)))*((y1) - 1.)*((y1) + 1.));\n// # 418 \"/home/spencer/basilisk/src/embed.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n\n\n\n\n\n    d[0] = max(1e-3, fabs(p.y/n.y));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n\n\n\n\n\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n// # 374 \"/home/spencer/basilisk/src/embed.h\"\n\nstatic inline real dirichlet_gradient_x (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.x = - n.x;\n    \n// #line 380\nn.y = - n.y;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(fs.x,(n.x > 0.),0,0))\n      defined = false;\n    \n// #line 384\nif (defined && !val(fs.y,0,(n.y > 0.),0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.x);\n      d[l] = (i - p.x)/n.x;\n      real y1 = p.y + d[l]*n.y;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(fs.x,i + (i < 0),j,0) && val(fs.y,i,j,0) && val(fs.y,i,j+1,0) &&\n   val(cs,i,j-1,0) && val(cs,i,j,0) && val(cs,i,j+1,0))\n v[l] = ((((val(s,i,j-1,0)))*((y1) - 1.) + ((val(s,i,j+1,0)))*((y1) + 1.))*(y1)/2. - ((val(s,i,j,0)))*((y1) - 1.)*((y1) + 1.));\n// # 418 \"/home/spencer/basilisk/src/embed.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n\n\n\n\n\n    d[0] = max(1e-3, fabs(p.x/n.x));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n\n\n\n\n\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n// #line 442 \"/home/spencer/basilisk/src/embed.h\"\nreal dirichlet_gradient (Point point, scalar s, scalar cs,\n      coord n, coord p, real bc, inout real  coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n\n  \n    if (fabs(n.x) >= fabs(n.y))\n      return dirichlet_gradient_x (point, s, cs, n, p, bc, coef);\n    \n// #line 447\nif (fabs(n.y) >= fabs(n.x))\n      return dirichlet_gradient_y (point, s, cs, n, p, bc, coef);\n// # 458 \"/home/spencer/basilisk/src/embed.h\"\n  return 1e30;\n}\n// # 470 \"/home/spencer/basilisk/src/embed.h\"\nstatic inline\ncoord embed_gradient (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn;\n   {\n    bool dirichlet = false;\n    real vb = u.x.boundary[embed] (point, point, u.x, &dirichlet);\n    if (dirichlet) {\n      real val;\n      dudn.x = dirichlet_gradient (point, u.x, cs, n, p, vb, val);\n    }\n    else\n      dudn.x = vb;\n    if (dudn.x == 1e30)\n      dudn.x = 0.;\n  } \n// #line 474\n{\n    bool dirichlet = false;\n    real vb = u.y.boundary[embed] (point, point, u.y, &dirichlet);\n    if (dirichlet) {\n      real val;\n      dudn.y = dirichlet_gradient (point, u.y, cs, n, p, vb, val);\n    }\n    else\n      dudn.y = vb;\n    if (dudn.y == 1e30)\n      dudn.y = 0.;\n  }\n  return dudn;\n}\n\n\n// #line 190 \"./../interfaceforce.h\"\nreal embed_vorticityo (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn = embed_gradient (point, u, p, n);\n\n  return dudn.y*n.x - dudn.x*n.y;\n}\n\nOMP(omp declare reduction (+ : coord :\n      omp_out.x += omp_in.x,\n      omp_out.y += omp_in.y,\n      omp_out.z += omp_in.z))\n// # 920 \"/home/spencer/basilisk/src/common.h\"\nvoid normalize (coord * n)\n{\n  real norm = 0.;\n  \n    norm += sq(n->x);\n    \n// #line 924\nnorm += sq(n->y);\n  norm = sqrt(norm);\n  \n    n->x /= norm;\n    \n// #line 927\nn->y /= norm;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}\n\n\n\n// #line 101 \"./../interfaceforce.h\"\nreal embed_geometryo (Point point, coord * b, coord * n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  *n = facet_normal (point, airfoil, sf);\n  real alpha = line_alpha (val(airfoil,0,0,0), *n);\n  real area = line_length_center(*n,alpha,b);\n  normalize (n);\n  return area;\n}","\n// #line 192 \"pitching.c\"\n{\n    real vort = val(omega,0,0,0);\n    real area = (sq(Delta)*val(cm,0,0,0));\n    E_p += sq(vort);\n    if (val(airfoil,0,0,0) < 1. && val(airfoil,0,0,0) > 0){\n      coord b, n;\n      area *= embed_geometryo (point, &b, &n);\n      vort = embed_vorticityo (point, u, b, n);\n    }\n    E += area*sq(vort);\n  }"}){  
...
#line 192
foreach_stencil(1,{(NonLocal[]){{"E","double",(void *)&E,NULL,0},{"u","vector",(void *)&u,NULL,0},{"cs","scalar",(void *)&cs,NULL,0},{"fs","vector",(void *)&fs,NULL,0},{"val","double",(void *)&val,NULL,0},{"embed","bid",(void *)&embed,NULL,0},{"sf","vector",(void *)&sf,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"E_p","double",(void *)&E_p,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"omega","scalar",(void *)&omega,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 375 \"/home/spencer/basilisk/src/embed.h\"\nstatic inline real dirichlet_gradient_y (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.y = - n.y;\n    \n// #line 380\nn.x = - n.x;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(fs.y,0,(n.y > 0.),0))\n      defined = false;\n    \n// #line 384\nif (defined && !val(fs.x,(n.x > 0.),0,0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.y);\n      d[l] = (i - p.y)/n.y;\n      real y1 = p.x + d[l]*n.x;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(fs.y,j,i + (i < 0),0) && val(fs.x,j,i,0) && val(fs.x,j+1,i,0) &&\n   val(cs,j-1,i,0) && val(cs,j,i,0) && val(cs,j+1,i,0))\n v[l] = ((((val(s,j-1,i,0)))*((y1) - 1.) + ((val(s,j+1,i,0)))*((y1) + 1.))*(y1)/2. - ((val(s,j,i,0)))*((y1) - 1.)*((y1) + 1.));\n// # 418 \"/home/spencer/basilisk/src/embed.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n\n\n\n\n\n    d[0] = max(1e-3, fabs(p.y/n.y));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n\n\n\n\n\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n// # 374 \"/home/spencer/basilisk/src/embed.h\"\n\nstatic inline real dirichlet_gradient_x (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.x = - n.x;\n    \n// #line 380\nn.y = - n.y;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(fs.x,(n.x > 0.),0,0))\n      defined = false;\n    \n// #line 384\nif (defined && !val(fs.y,0,(n.y > 0.),0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.x);\n      d[l] = (i - p.x)/n.x;\n      real y1 = p.y + d[l]*n.y;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(fs.x,i + (i < 0),j,0) && val(fs.y,i,j,0) && val(fs.y,i,j+1,0) &&\n   val(cs,i,j-1,0) && val(cs,i,j,0) && val(cs,i,j+1,0))\n v[l] = ((((val(s,i,j-1,0)))*((y1) - 1.) + ((val(s,i,j+1,0)))*((y1) + 1.))*(y1)/2. - ((val(s,i,j,0)))*((y1) - 1.)*((y1) + 1.));\n// # 418 \"/home/spencer/basilisk/src/embed.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n\n\n\n\n\n    d[0] = max(1e-3, fabs(p.x/n.x));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n\n\n\n\n\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n// #line 442 \"/home/spencer/basilisk/src/embed.h\"\nreal dirichlet_gradient (Point point, scalar s, scalar cs,\n      coord n, coord p, real bc, inout real  coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n\n  \n    if (fabs(n.x) >= fabs(n.y))\n      return dirichlet_gradient_x (point, s, cs, n, p, bc, coef);\n    \n// #line 447\nif (fabs(n.y) >= fabs(n.x))\n      return dirichlet_gradient_y (point, s, cs, n, p, bc, coef);\n// # 458 \"/home/spencer/basilisk/src/embed.h\"\n  return 1e30;\n}\n// # 470 \"/home/spencer/basilisk/src/embed.h\"\nstatic inline\ncoord embed_gradient (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn;\n   {\n    bool dirichlet = false;\n    real vb = u.x.boundary[embed] (point, point, u.x, &dirichlet);\n    if (dirichlet) {\n      real val;\n      dudn.x = dirichlet_gradient (point, u.x, cs, n, p, vb, val);\n    }\n    else\n      dudn.x = vb;\n    if (dudn.x == 1e30)\n      dudn.x = 0.;\n  } \n// #line 474\n{\n    bool dirichlet = false;\n    real vb = u.y.boundary[embed] (point, point, u.y, &dirichlet);\n    if (dirichlet) {\n      real val;\n      dudn.y = dirichlet_gradient (point, u.y, cs, n, p, vb, val);\n    }\n    else\n      dudn.y = vb;\n    if (dudn.y == 1e30)\n      dudn.y = 0.;\n  }\n  return dudn;\n}\n\n\n// #line 190 \"./../interfaceforce.h\"\nreal embed_vorticityo (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn = embed_gradient (point, u, p, n);\n\n  return dudn.y*n.x - dudn.x*n.y;\n}\n\nOMP(omp declare reduction (+ : coord :\n      omp_out.x += omp_in.x,\n      omp_out.y += omp_in.y,\n      omp_out.z += omp_in.z))\n// # 920 \"/home/spencer/basilisk/src/common.h\"\nvoid normalize (coord * n)\n{\n  real norm = 0.;\n  \n    norm += sq(n->x);\n    \n// #line 924\nnorm += sq(n->y);\n  norm = sqrt(norm);\n  \n    n->x /= norm;\n    \n// #line 927\nn->y /= norm;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}\n\n\n\n// #line 101 \"./../interfaceforce.h\"\nreal embed_geometryo (Point point, coord * b, coord * n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  *n = facet_normal (point, airfoil, sf);\n  real alpha = line_alpha (val(airfoil,0,0,0), *n);\n  real area = line_length_center(*n,alpha,b);\n  normalize (n);\n  return area;\n}","\n// #line 192 \"pitching.c\"\n{\n    real vort = val(omega,0,0,0);\n    real area = (sq(Delta)*_const_cm);\n    E_p += sq(vort);\n    if (val(airfoil,0,0,0) < 1. && val(airfoil,0,0,0) > 0){\n      coord b, n;\n      area *= embed_geometryo (point, &b, &n);\n      vort = embed_vorticityo (point, u, b, n);\n    }\n    E += area*sq(vort);\n  }"}){  
     _stencil_val(omega,0,0,0);
; 
...
foreach(){
  ...
  fprintf (ferr, "%d %g %d %d %d %d %d %g %g %g %g %g\n",
    i, t, j, mgp.i, mgp.nrelax, mgu.i, mgu.nrelax, CD, CL, E, E_p, theta_p*(180/3.14159265358979));delete((scalar*)((scalar[]){omega,{-1}}));

}{end_tracing("logfile","pitching.c",0);return 0;}end_tracing("logfile","pitching.c",0);}
#line 226
...
static int screenshot_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= t_end)!=0;*ip=i;*tp=t;return ret;}static int screenshot_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.5)!=0;*ip=i;*tp=t;return ret;}


#line 230
      static int screenshot(const int i,const double t,Event *_ev){tracing("screenshot","pitching.c",0); {
  view ( 
-0.25, -0.5
#line 231
,2
...
#line 232 "pitching.c"
,
#line 54 "/home/spencer/basilisk/src/draw.h"
(
...
#line 231 "pitching.c"
, "front"
#line 59 "/home/spencer/basilisk/src/draw.h"
, 
NULL, 
0, 
0., 0., 0., 0., 
...
}{end_tracing("screenshot","pitching.c",0);return 0;}end_tracing("screenshot","pitching.c",0);}

static int adapt_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++)!=0;*ip=i;*tp=t;return ret;}


#line 243
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","pitching.c",0); {
  adapt_wavelet (
#line 244 "/home/spencer/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 244
...
}{end_tracing("adapt_0","pitching.c",0);return 0;}end_tracing("adapt_0","pitching.c",0);}
...
#line 12 "ast/init_solver.h"
{
      ...
      {  
#line 895 "/home/spencer/basilisk/src/embed.h"
event_register((Event){0,1,metric,{metric_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/embed.h",0,"metric"});  
#line 938
event_register((Event){0,1,defaults,{defaults_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/embed.h",0,"defaults"});  
#line 42 "/home/spencer/basilisk/src/run.h"
event_register((Event){0,1,defaults_0,{defaults_0_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/run.h",0,"defaults"});  
#line 126 "/home/spencer/basilisk/src/navier-stokes/centered.h"
event_register((Event){0,1,defaults_1,{defaults_1_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/navier-stokes/centered.h",0,"defaults"});  
#line 187
...
#line 127 "pitching.c"
event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"pitching.c",0,"init"});  
#line 146
event_register((Event){0,1,moving_cylinder,{moving_cylinder_expr0},((int *)0),((double *)0),"pitching.c",0,"moving_cylinder"});  
#line 180
event_register((Event){0,2,logfile,{logfile_expr0,logfile_expr1},((int *)0),((double *)0),"pitching.c",0,"logfile"});  
#line 226
event_register((Event){0,2,movie,{movie_expr0,movie_expr1},((int *)0),((double *)0),"pitching.c",0,"movie"});  



event_register((Event){0,2,screenshot,{screenshot_expr0,screenshot_expr1},((int *)0),((double *)0),"pitching.c",0,"screenshot"});
...
#line 173 "pitching.c"
event_register((Event){0,1,properties_0,{properties_0_expr0},((int *)0),((double *)0),"pitching.c",0,"properties"});  
#line 243
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"pitching.c",0,"adapt"});

...
plot 'embed/vprofy1-1' u a:b t 'embed' ls 1, \
        'ibm/vprofy1-1' u a:b t 'old IBM' ls 5, \
            'ibmnz/vprofy1-1' u a:b t 'bilinear IBM' ls 3, \
                'embed/vprofy1-1' u a:b notitle w l ls 1 lw 1

@BMARGIN; @LMARGIN; @XTICS; @YTICS
set label 1 'Re = 2' @POS
plot 'embed/vprofy1-2' u a:b t 'embed' ls 1, \
        'ibm/vprofy1-2' u a:b t 'old IBM' ls 5, \
            'ibmnz/vprofy1-2' u a:b t 'bilinear IBM' ls 3, \
                'embed/vprofy1-2' u a:b notitle w l ls 1 lw 1

@TMARGIN; @CMARGIN; @NOXTICS; @NOYTICS
set label 1 'Re = 5' @POS
plot 'embed/vprofy1-5' u a:b t 'embed' ls 1, \
        'ibm/vprofy1-5' u a:b t 'old IBM' ls 5, \
            'ibmnz/vprofy1-5' u a:b t 'bilinear IBM' ls 3, \
                'embed/vprofy1-5' u a:b notitle w l ls 1 lw 1

@BMARGIN; @CMARGIN; @XTICS; @NOYTICS
set label 1 'Re = 10' @POS
plot 'embed/vprofy1-10' u a:b t 'embed' ls 1, \
        'ibm/vprofy1-10' u a:b t 'IBM w/z' ls 5, \
            'ibmnz/vprofy1-10' u a:b t 'IBM w/o z' ls 3, \
                'embed/vprofy1-10' u a:b notitle w l ls 1 lw 1

@TMARGIN; @RMARGIN; @NOXTICS; @NOYTICS
set label 1 'Re = 20' @POS
plot 'embed/vprofy1-20' u a:b t 'embed' ls 1, \
        'ibm/vprofy1-20' u a:b t 'old IBM' ls 5, \
            'ibmnz/vprofy1-20' u a:b t 'bilinear IBM' ls 3, \
                'embed/vprofy1-20' u a:b notitle w l ls 1 lw 1

@BMARGIN; @RMARGIN; @XTICS; @NOYTICS
set label 1 'Re = 40' @POS
plot 'embed/vprofy1-40' u a:b t 'embed' ls 1, \
        'ibm/vprofy1-40' u a:b t 'old IBM' ls 5, \
            'ibmnz/vprofy1-40' u a:b t 'bilinear IBM' ls 3, \
                'embed/vprofy1-40' u a:b notitle w l ls 1 lw 1

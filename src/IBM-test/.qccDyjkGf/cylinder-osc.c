#line 0 "cylinder-osc-cpp.c"
#line 0 "<built-in>"
#line 0 "<command-line>"
#line 1 "/usr/include/stdc-predef.h"
#line 0 "<command-line>"
#line 1 "cylinder-osc-cpp.c"
#if 700 < 700
  #undef 700
  #define 700 700
#endif
...
#line 4 "cylinder-osc.c"
#line 1 "view.h"
#line 5 "cylinder-osc.c"


double RE, KC, Amp, freq;
const double U0 = 1;
const double D = 0.5;
double t_end = 62.5;
...
#line 53
  ...
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"D","double",(void *)&D,NULL,0},{"xc","coord",(void *)&xc,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 58 \"cylinder-osc.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x - xc.x) - sq(y - ci.y - xc.y) + sq(D/2);"}) {_stencil_val_a(phi,0,0,0);               }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x - xc.x) - sq(y - ci.y - xc.y) + sq(D/2);end_foreach_vertex();} fractions (phi, airfoil, sf
...
#line 70
foreach_face_stencil(1,{(NonLocal[]){{"RE","double",(void *)&RE,NULL,0},{"D","double",(void *)&D,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 70 \"cylinder-osc.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(D)/(RE);}end_is_face_x()\n// #line 70\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(D)/(RE);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 70
foreach_face_stencil(1,{(NonLocal[]){{"RE","double",(void *)&RE,NULL,0},{"D","double",(void *)&D,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 70 \"cylinder-osc.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(D)/(RE);}end_is_face_x()\n// #line 70\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(D)/(RE);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 80
  ...
  fprintf (ferr, "%d %g %d %d %d %d %g %g %g %g %g %d\n",

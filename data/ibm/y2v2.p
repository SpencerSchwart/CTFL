...
plot 'ce11v2/vprofy2-1' u a:b t 'embed' w l ls 1, \
        'ibmz/vprofy2-1' u a:b t 'IBM w/z' w l ls 3, \
            'ibmnz/vprofy2-1' u a:b t 'IBM w/o z' w l ls 4

@BMARGIN; @LMARGIN; @XTICS; @YTICS
set label 1 'Re = 2' @POS
plot 'ce11v2/vprofy2-2' u a:b t 'embed' w l ls 1, \
        'ibmz/vprofy2-2' u a:b t 'IBM w/z' w l ls 3, \
            'ibmnz/vprofy2-2' u a:b t 'IBM w/o z' w l ls 4

@TMARGIN; @CMARGIN; @NOXTICS; @NOYTICS
set label 1 'Re = 5' @POS
plot 'ce11v2/vprofy2-5' u a:b t 'embed' w l ls 1, \
        'ibmz/vprofy2-5' u a:b t 'IBM w/z' w l ls 3, \
            'ibmnz/vprofy2-5' u a:b t 'IBM w/o z' w l ls 4

@BMARGIN; @CMARGIN; @XTICS; @NOYTICS
set label 1 'Re = 10' @POS
plot 'ce11v2/vprofy2-10' u a:b t 'embed' w l ls 1, \
        'ibmz/vprofy2-10' u a:b t 'IBM w/z' w l ls 3, \
            'ibmnz/vprofy2-10' u a:b t 'IBM w/o z' w l ls 4

@TMARGIN; @RMARGIN; @NOXTICS; @NOYTICS
set label 1 'Re = 20' @POS
plot 'ce11v2/vprofy2-20' u a:b t 'embed' w l ls 1, \
        'ibmz/vprofy2-20' u a:b t 'IBM w/z' w l ls 3, \
            'ibmnz/vprofy2-20' u a:b t 'IBM w/o z' w l ls 4

@BMARGIN; @RMARGIN; @XTICS; @NOYTICS
set label 1 'Re = 40' @POS
plot 'ce11v2/vprofy2-40' u a:b t 'embed' w l ls 1, \
        'ibmz/vprofy2-40' u a:b t 'IBM w/z' w l ls 3, \
            'ibmnz/vprofy2-40' u a:b t 'IBM w/o z' w l ls 4

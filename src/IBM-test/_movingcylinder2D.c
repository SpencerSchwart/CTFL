#line 0 "movingcylinder2D-cpp.c"
#line 1 "/home/spencer/basilisk/CTFL/src/IBM-test/.qccthZg4B//"
#line 0 "<built-in>"
#line 0 "<command-line>"
#line 1 "/usr/include/stdc-predef.h"
#line 0 "<command-line>"
#line 1 "movingcylinder2D-cpp.c"
#if 700 < 700
  #undef 700
  #define 700 700
#endif
...
#line 14 "movingcylinder2D-cpp.c"
...
#line 15 "movingcylinder2D-cpp.c"
...
#line 348
foreach_face_stencil(1,{(NonLocal[]){{"ferr","not implemented yet",(void *)ferr,NULL,1},{"cs","scalar",(void *)&cs,NULL,0},{"fs","vector",(void *)&fs,NULL,0},{"a","scalar",(void *)&a,NULL,0},{"alpha","vector",(void *)&alpha,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 71 \"/home/spencer/basilisk/src/embed.h\"\nstatic inline real embed_face_gradient_y (Point point, scalar a, int i)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int j = sign(val(fs.y,1,i,0) - val(fs.y,-1,i,0));\n  if (!(val(cs,0,i,0) && val(cs,0,i-1,0))) qassert (\"/home/spencer/basilisk/src/embed.h\", 74, \"cs[i] && cs[i-1]\");\n  if ((val(fs.y,j,i,0) > 0.5 && val(fs.x,j + (j < 0),i,0) && val(fs.x,j + (j < 0),i-1,0) && val(cs,j,i,0) && val(cs,j,i-1,0)))\n    return ((1. + val(fs.y,0,i,0))*(val(a,0,i,0) - val(a,0,i-1,0)) +\n     (1. - val(fs.y,0,i,0))*(val(a,j,i,0) - val(a,j,i-1,0)))/(2.*Delta);\n  return (val(a,0,i,0) - val(a,0,i-1,0))/Delta;\n}\n@ def not_mpi_compatible()\ndo {\n  if (npe() > 1) {\n    fprintf (ferr, \"%s() is not compatible with MPI (yet)\\n\", __func__);\n    exit (1);\n  }\n} while(0)\n@\n@ define system(command) (pid() == 0 ? system(command) : 0)\n@else\n@ define qstderr() stderr\n@ define qstdout() stdout\n@ define ferr stderr\n@ define fout stdout\n@ define not_mpi_compatible()\n@endif\n\n\n\n\n// #line 93 \"/home/spencer/basilisk/src/common.h\"\nstatic inline void qassert (const char * file, int line, const char * cond) {\n  fprintf (ferr, \"%s:%d: Assertion `%s' failed.\\n\", file, line, cond);\n  abort();\n}\n// # 30 \"/home/spencer/basilisk/src/embed.h\" 2\n// # 70 \"/home/spencer/basilisk/src/embed.h\"\n\nstatic inline real embed_face_gradient_x (Point point, scalar a, int i)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int j = sign(val(fs.x,i,1,0) - val(fs.x,i,-1,0));\n  if (!(val(cs,i,0,0) && val(cs,i-1,0,0))) qassert (\"/home/spencer/basilisk/src/embed.h\", 74, \"cs[i] && cs[i-1]\");\n  if ((val(fs.x,i,j,0) > 0.5 && val(fs.y,i,j + (j < 0),0) && val(fs.y,i-1,j + (j < 0),0) && val(cs,i,j,0) && val(cs,i-1,j,0)))\n    return ((1. + val(fs.x,i,0,0))*(val(a,i,0,0) - val(a,i-1,0,0)) +\n     (1. - val(fs.x,i,0,0))*(val(a,i,j,0) - val(a,i-1,j,0)))/(2.*Delta);\n  return (val(a,i,0,0) - val(a,i-1,0,0))/Delta;\n}","\n// #line 348 \"/home/spencer/basilisk/src/poisson.h\"\n{is_face_x(){\n    val_out_(g.x,0,0,0) = val(alpha.x,0,0,0)*(a.third && val(fs.x,0,0,0) < 1. && val(fs.x,0,0,0) > 0. ? embed_face_gradient_x (point, a, 0) : (val(a,0,0,0) - val(a,0 -1,0,0))/Delta);}end_is_face_x()\n// #line 348\nis_face_y(){\n    val_out_(g.y,0,0,0) = val(alpha.y,0,0,0)*(a.third && val(fs.y,0,0,0) < 1. && val(fs.y,0,0,0) > 0. ? embed_face_gradient_y (point, a, 0) : (val(a,0,0,0) - val(a,0,0 -1,0))/Delta);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 348
_stencil_is_face_y(){
    { _stencil_val(alpha.y,0,0,0); _stencil_val(fs.y,0,0,0); _stencil_val(fs.y,0,0,0); _stencil_embed_face_gradient_y (point, a, 0);_stencil_val(a,0,0,0); _stencil_val(a,0,0 -1,0);_stencil_val_a(g.y,0,0,0);           }}end__stencil_is_face_y()}end_foreach_face_stencil();{
#line 348
foreach_face_generic(){is_face_x(){
...
#line 348
is_face_y(){
    val(g.y,0,0,0) = val(alpha.y,0,0,0)*(_attribute[a.i].third && val(fs.y,0,0,0) < 1. && val(fs.y,0,0,0) > 0. ? embed_face_gradient_y (point, a, 0) : (val(a,0,0,0) - val(a,0,0 -1,0))/Delta);}end_is_face_y()}end_foreach_face_generic();}}else {_coord _const_alpha={_constant[alpha.x.i-_NVARMAX],_constant[alpha.y.i-_NVARMAX]};NOT_UNUSED(_const_alpha);
  
#line 348
foreach_face_stencil(1,{(NonLocal[]){{"ferr","not implemented yet",(void *)ferr,NULL,1},{"cs","scalar",(void *)&cs,NULL,0},{"fs","vector",(void *)&fs,NULL,0},{"a","scalar",(void *)&a,NULL,0},{"_const_alpha","_coord",(void *)&_const_alpha,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 71 \"/home/spencer/basilisk/src/embed.h\"\nstatic inline real embed_face_gradient_y (Point point, scalar a, int i)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int j = sign(val(fs.y,1,i,0) - val(fs.y,-1,i,0));\n  if (!(val(cs,0,i,0) && val(cs,0,i-1,0))) qassert (\"/home/spencer/basilisk/src/embed.h\", 74, \"cs[i] && cs[i-1]\");\n  if ((val(fs.y,j,i,0) > 0.5 && val(fs.x,j + (j < 0),i,0) && val(fs.x,j + (j < 0),i-1,0) && val(cs,j,i,0) && val(cs,j,i-1,0)))\n    return ((1. + val(fs.y,0,i,0))*(val(a,0,i,0) - val(a,0,i-1,0)) +\n     (1. - val(fs.y,0,i,0))*(val(a,j,i,0) - val(a,j,i-1,0)))/(2.*Delta);\n  return (val(a,0,i,0) - val(a,0,i-1,0))/Delta;\n}\n@ def not_mpi_compatible()\ndo {\n  if (npe() > 1) {\n    fprintf (ferr, \"%s() is not compatible with MPI (yet)\\n\", __func__);\n    exit (1);\n  }\n} while(0)\n@\n@ define system(command) (pid() == 0 ? system(command) : 0)\n@else\n@ define qstderr() stderr\n@ define qstdout() stdout\n@ define ferr stderr\n@ define fout stdout\n@ define not_mpi_compatible()\n@endif\n\n\n\n\n// #line 93 \"/home/spencer/basilisk/src/common.h\"\nstatic inline void qassert (const char * file, int line, const char * cond) {\n  fprintf (ferr, \"%s:%d: Assertion `%s' failed.\\n\", file, line, cond);\n  abort();\n}\n// # 30 \"/home/spencer/basilisk/src/embed.h\" 2\n// # 70 \"/home/spencer/basilisk/src/embed.h\"\n\nstatic inline real embed_face_gradient_x (Point point, scalar a, int i)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int j = sign(val(fs.x,i,1,0) - val(fs.x,i,-1,0));\n  if (!(val(cs,i,0,0) && val(cs,i-1,0,0))) qassert (\"/home/spencer/basilisk/src/embed.h\", 74, \"cs[i] && cs[i-1]\");\n  if ((val(fs.x,i,j,0) > 0.5 && val(fs.y,i,j + (j < 0),0) && val(fs.y,i-1,j + (j < 0),0) && val(cs,i,j,0) && val(cs,i-1,j,0)))\n    return ((1. + val(fs.x,i,0,0))*(val(a,i,0,0) - val(a,i-1,0,0)) +\n     (1. - val(fs.x,i,0,0))*(val(a,i,j,0) - val(a,i-1,j,0)))/(2.*Delta);\n  return (val(a,i,0,0) - val(a,i-1,0,0))/Delta;\n}","\n// #line 348 \"/home/spencer/basilisk/src/poisson.h\"\n{is_face_x(){\n    val_out_(g.x,0,0,0) = _const_alpha.x*(a.third && val(fs.x,0,0,0) < 1. && val(fs.x,0,0,0) > 0. ? embed_face_gradient_x (point, a, 0) : (val(a,0,0,0) - val(a,0 -1,0,0))/Delta);}end_is_face_x()\n// #line 348\nis_face_y(){\n    val_out_(g.y,0,0,0) = _const_alpha.y*(a.third && val(fs.y,0,0,0) < 1. && val(fs.y,0,0,0) > 0. ? embed_face_gradient_y (point, a, 0) : (val(a,0,0,0) - val(a,0,0 -1,0))/Delta);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 126 "/home/spencer/basilisk/src/navier-stokes/centered.h"
      static int defaults_1(const int i,const double t,Event *_ev){tracing("defaults_1","/home/spencer/basilisk/src/navier-stokes/centered.h",126);
{
...
}{end_tracing("defaults_1","/home/spencer/basilisk/src/navier-stokes/centered.h",181);return 0;}end_tracing("defaults_1","/home/spencer/basilisk/src/navier-stokes/centered.h",181);}
...
#line 1 "/home/spencer/basilisk/src/navier-stokes/perfs.h"
      ...
      static int perfs(const int i,const double t,Event *_ev){tracing("perfs","/home/spencer/basilisk/src/navier-stokes/perfs.h",7); {
  ...
  fprintf (fp, "%g %g %d %d %d %d %d %d %ld %g %g %d\n",
    ...
    grid->tn, perf.t, perf.speed, npe());
  fflush (fp);
}{end_tracing("perfs","/home/spencer/basilisk/src/navier-stokes/perfs.h",17);return 0;}end_tracing("perfs","/home/spencer/basilisk/src/navier-stokes/perfs.h",17);}
...
#line 24
      static int perf_plot(const int i,const double t,Event *_ev){tracing("perf_plot","/home/spencer/basilisk/src/navier-stokes/perfs.h",24); {
  if (getenv ("DISPLAY"))
    qpopen ("gnuplot -e 'set term x11 noraise title perfs' "
    "$BASILISK/navier-stokes/perfs.plot "
    "& read dummy; kill $!", "w");
}{end_tracing("perf_plot","/home/spencer/basilisk/src/navier-stokes/perfs.h",29);return 0;}end_tracing("perf_plot","/home/spencer/basilisk/src/navier-stokes/perfs.h",29);}
#line 5 "movingcylinder2D.c"
...
#line 14 "./../immersed.h"
      static int end_timestep_0(const int i,const double t,Event *_ev){tracing("end_timestep_0","./../immersed.h",14); {

  foreach_stencil(1,{(NonLocal[]){{"dt","double",(void *)&dt,NULL,0},{"u","vector",(void *)&u,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"aF","vector",(void *)&aF,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 17 \"./../immersed.h\"\n{\n      val_out_(aF.x,0,0,0) = val(airfoil,0,0,0)*(vc.x-val(u.x,0,0,0))/(dt);\n      \n// #line 18\nval_out_(aF.y,0,0,0) = val(airfoil,0,0,0)*(vc.y-val(u.y,0,0,0))/(dt);}"})
    {
      { _stencil_val(airfoil,0,0,0);_stencil_val(u.x,0,0,0);_stencil_val_a(aF.x,0,0,0); }
      
#line 18
{ _stencil_val(airfoil,0,0,0);_stencil_val(u.y,0,0,0);_stencil_val_a(aF.y,0,0,0); }}end_foreach_stencil();
...
#line 18
val(aF.y,0,0,0) = val(airfoil,0,0,0)*(vc.y-val(u.y,0,0,0))/(dt);}end_foreach();}

  correction(-dt);
  if(!is_constant(fm.x)){
  
#line 21
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 22 \"./../immersed.h\"\n{\n      val_out_(g.x,0,0,0) += val(fm.x,0,0,0)*val(aF.x,0,0,0);\n      \n// #line 23\nval_out_(g.y,0,0,0) += val(fm.y,0,0,0)*val(aF.y,0,0,0);}"})
    {
      { _stencil_val(fm.x,0,0,0);_stencil_val(aF.x,0,0,0);_stencil_val_r(g.x,0,0,0); }
      
#line 23
{ _stencil_val(fm.y,0,0,0);_stencil_val(aF.y,0,0,0);_stencil_val_r(g.y,0,0,0); }}end_foreach_stencil();{
#line 21
foreach()
    {
      val(g.x,0,0,0) += val(fm.x,0,0,0)*val(aF.x,0,0,0);
      
#line 23
val(g.y,0,0,0) += val(fm.y,0,0,0)*val(aF.y,0,0,0);}end_foreach();}}else {_coord _const_fm={_constant[fm.x.i-_NVARMAX],_constant[fm.y.i-_NVARMAX]};NOT_UNUSED(_const_fm);
  
#line 21
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 22 \"./../immersed.h\"\n{\n      val_out_(g.x,0,0,0) += _const_fm.x*val(aF.x,0,0,0);\n      \n// #line 23\nval_out_(g.y,0,0,0) += _const_fm.y*val(aF.y,0,0,0);}"})
    {
...
foreach()
    {
      val(g.x,0,0,0) += _const_fm.x*val(aF.x,0,0,0);
      
#line 23
val(g.y,0,0,0) += _const_fm.y*val(aF.y,0,0,0);}end_foreach();}}
  correction(dt);

}{end_tracing("end_timestep_0","./../immersed.h",26);return 0;}end_tracing("end_timestep_0","./../immersed.h",26);}
...
void normal_vector (scalar s, vector nv) {
  foreach_stencil(1,{(NonLocal[]){{"s","scalar",(void *)&s,NULL,0},{"nv","vector",(void *)&nv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 36 \"./../immersed.h\"\n{\n      val_out_(nv.x,0,0,0) = (val(s,1,0,0) - val(s,-1,0,0))/(2.*Delta);\n      \n// #line 37\nval_out_(nv.y,0,0,0) = (val(s,0,1,0) - val(s,0,-1,0))/(2.*Delta);}"})
    {
      {_stencil_val(s,1,0,0); _stencil_val(s,-1,0,0);_stencil_val_a(nv.x,0,0,0);   }
      
#line 37
{_stencil_val(s,0,1,0); _stencil_val(s,0,-1,0);_stencil_val_a(nv.y,0,0,0);   }}end_foreach_stencil();
  {
#line 35
foreach()
    {
      val(nv.x,0,0,0) = (val(s,1,0,0) - val(s,-1,0,0))/(2.*Delta);
      
#line 37
val(nv.y,0,0,0) = (val(s,0,1,0) - val(s,0,-1,0))/(2.*Delta);}end_foreach();}

  foreach_stencil(1,{(NonLocal[]){{"nv","vector",(void *)&nv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 39 \"./../immersed.h\"\n{\n    real mag = 0;\n    \n      mag += sq(val(nv.x,0,0,0));\n      \n// #line 42\nmag += sq(val(nv.y,0,0,0));\n    mag = sqrt(mag);\n    if (mag > 0)\n      {\n val_out_(nv.x,0,0,0) /= mag;\n \n// #line 46\nval_out_(nv.y,0,0,0) /= mag;}\n  }"}) {   
    
    
      {_stencil_val(nv.x,0,0,0);  }
      
#line 42
{_stencil_val(nv.y,0,0,0);  }
      
 

{_stencil_val_r(nv.x,0,0,0);  }
 
#line 46
{_stencil_val_r(nv.y,0,0,0);  }
...
double int_area (Point point, coord * b, coord * n) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  *n = facet_normal (point, airfoil, sf);
  double alpha = line_alpha (val(airfoil,0,0,0), *n);
...
#line 50
static void _stencil_int_area (Point point,_stencil_undefined * b,_stencil_undefined * n) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES; 
_stencil_facet_normal (point, airfoil, sf);     
...
void immersed_force (scalar c, coord * F) {
  coord Fi = {0, 0};
  vector  nv=new_vector("nv");

  foreach_stencil(1,{(NonLocal[]){{"Fi","coord",(void *)&Fi,NULL,0},{"aF","vector",(void *)&aF,NULL,0},{"sf","vector",(void *)&sf,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\nOMP(omp declare reduction (+ : coord :\n      omp_out.x += omp_in.x,\n      omp_out.y += omp_in.y,\n      omp_out.z += omp_in.z))\n// # 920 \"/home/spencer/basilisk/src/common.h\"\nvoid normalize (coord * n)\n{\n  real norm = 0.;\n  \n    norm += sq(n->x);\n    \n// #line 924\nnorm += sq(n->y);\n  norm = sqrt(norm);\n  \n    n->x /= norm;\n    \n// #line 927\nn->y /= norm;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"movingcylinder2D-cpp.c\" 2\n// # 1 \"movingcylinder2D.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}\n\n\n// #line 50 \"./../immersed.h\"\nreal int_area (Point point, coord * b, coord * n) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  *n = facet_normal (point, airfoil, sf);\n  real alpha = line_alpha (val(airfoil,0,0,0), *n);\n  real area = line_length_center(*n,alpha,b);\n  normalize (n);\n  return area;\n}"," \n// #line 63 \"./../immersed.h\"\n{\n    if (val(c,0,0,0) > 0. && val(c,0,0,0) < 1.) {\n      coord n,b;\n      real area = int_area (point, &b, &n);\n      area *= pow (Delta, 2 - 1);\n      real Fn_x = val(aF.x,0,0,0)*n.x + val(aF.y,0,0,0)*n.x;\n      real Fn_y = val(aF.x,0,0,0)*n.y + val(aF.y,0,0,0)*n.y;\n      \n        Fi.x += (Fn_x*area);\n        \n// #line 71\nFi.y += (Fn_y*area);\n    }\n  }"}) {
_stencil_val(c,0,0,0); _stencil_val(c,0,0,0); {   
      
       _stencil_int_area (point,NULL ,NULL );   
            
       _stencil_val(aF.y,0,0,0); _stencil_val(aF.x,0,0,0);   
       _stencil_val(aF.y,0,0,0); _stencil_val(aF.x,0,0,0);
...
foreach() {
    if (val(c,0,0,0) > 0. && val(c,0,0,0) < 1.) {
      ...
      area *= pow (Delta, 2 - 1);
      double Fn_x = val(aF.x,0,0,0)*n.x + val(aF.y,0,0,0)*n.x;
      double Fn_y = val(aF.x,0,0,0)*n.y + val(aF.y,0,0,0)*n.y;
...
Fi.y += (Fn_y*area);
  ...
  *F = Fi;delete((scalar*)((vector[]){nv,{{-1},{-1}}}));
}
#line 7 "movingcylinder2D.c"
...
void boundary_cells (scalar c, scalar ink) {
  ...
  foreach_stencil(1,{(NonLocal[]){{"phi","scalar",(void *)&phi,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 8 \"./../interfaceforce.h\"\n{\n    if(val(c,0,0,0) > 1e-6 && val(c,0,0,0) < 1. - 1e-6)\n      val_out_(phi,0,0,0) = 1.;\n    else\n      val_out_(phi,0,0,0) = -1.;\n  }"}) {
_stencil_val(c,0,0,0); _stencil_val(c,0,0,0);{
...
foreach() {
  ...
  boundary_internal ((scalar *)((scalar[]){phi,{-1}}), "./../interfaceforce.h", 14);
  fractions (phi, ink
...
n.y = - n.y;
  ...
  bool defined = true;
    ...
    if (defined && !val(sf.x,(n.x > 0.),0,0))
      defined = false;
    
#line 32
if (defined && !val(sf.y,0,(n.y > 0.),0))
      defined = false;
  if (defined)
    for (int l = 0; l <= 1; l++) {
      int i = (l + 1)*sign(n.x);
      ...
      if (val(sf.x,i + (i < 0),j,0) && val(sf.y,i,j,0) && val(sf.y,i,j+1,0) &&
   val(cs,i,j-1,0) && val(cs,i,j,0) && val(cs,i,j+1,0))
 v[l] = ((((val(s,i,j-1,0)))*((y1) - 1.) + ((val(s,i,j+1,0)))*((y1) + 1.))*(y1)/2. - ((val(s,i,j,0)))*((y1) - 1.)*((y1) + 1.));
#line 66 "./../interfaceforce.h"
      else
 break;
    }
  if (v[0] == 1e30) {
...
#line 23
static inline double dirichlet_gradiento_y (Point point, scalar s, scalar cs,
        coord n, coord p, double bc,
        double * coef)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
...
if (defined && !val(sf.x,(n.x > 0.),0,0))
  ...
  if (defined)
    for (int l = 0; l <= 1; l++) {
      ...
      if (val(sf.y,j,i + (i < 0),0) && val(sf.x,j,i,0) && val(sf.x,j+1,i,0) &&
   val(cs,j-1,i,0) && val(cs,j,i,0) && val(cs,j+1,i,0))
 v[l] = ((((val(s,j-1,i,0)))*((y1) - 1.) + ((val(s,j+1,i,0)))*((y1) + 1.))*(y1)/2. - ((val(s,j,i,0)))*((y1) - 1.)*((y1) + 1.));
#line 66 "./../interfaceforce.h"
      else
...
#line 23
static void _stencil_dirichlet_gradiento_x (Point point, scalar s, scalar cs,
_stencil_undefined * n,_stencil_undefined * p,_stencil_undefined * bc,
_stencil_undefined * coef)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;       
    ...
    {_stencil_val(sf.x,o_stencil,0,0  ); 
          }
    
#line 32
{_stencil_val(sf.y,0,o_stencil,0  ); 
          }
...
_stencil_val(sf.x,    o_stencil,o_stencil,0); _stencil_val(sf.y,o_stencil,o_stencil,0); _stencil_val(sf.y,o_stencil,o_stencil,0);
   _stencil_val(cs,o_stencil,o_stencil,0); _stencil_val(cs,o_stencil,o_stencil,0); _stencil_val(cs,o_stencil,o_stencil,0);
#line 42
{
...
#line 23
static void _stencil_dirichlet_gradiento_y (Point point, scalar s, scalar cs,
_stencil_undefined * n,_stencil_undefined * p,_stencil_undefined * bc,
_stencil_undefined * coef)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;       
...
_stencil_val(sf.y,o_stencil,    o_stencil,0); _stencil_val(sf.x,o_stencil,o_stencil,0); _stencil_val(sf.x,o_stencil,o_stencil,0);
   _stencil_val(cs,o_stencil,o_stencil,0); _stencil_val(cs,o_stencil,o_stencil,0); _stencil_val(cs,o_stencil,o_stencil,0);
#line 42
{
...
#line 81
static void _stencil_dirichlet_gradiento (Point point, scalar s, scalar cs,
_stencil_undefined * n,_stencil_undefined * p,_stencil_undefined * bc,_stencil_undefined * coef)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;

  
      
{ _stencil_dirichlet_gradiento_x (point, s, cs,NULL ,NULL ,NULL ,NULL );}
      
#line 87
{ _stencil_dirichlet_gradiento_y (point, s, cs,NULL ,NULL ,NULL ,NULL );}
...
#line 101
static void _stencil_embed_geometryo (Point point,_stencil_undefined * b,_stencil_undefined * n)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES; 
_stencil_facet_normal (point, airfoil, sf);     
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  if (!(2 == 2)) qassert ("./../interfaceforce.h", 112, "dimension == 2");
  int i = sign(p.x), j = sign(p.y);
  if (val(airfoil,i,0,0) && val(airfoil,0,j,0) && val(airfoil,i,j,0))
    ...
    double val = val(s,0,0,0);
     {
      int i = sign(p.x);
      if (val(airfoil,i,0,0))
 val += fabs(p.x)*(val(s,i,0,0) - val(s,0,0,0));
      else if (val(airfoil,-i,0,0))
 val += fabs(p.x)*(val(s,0,0,0) - val(s,-i,0,0));
    } 
#line 122
{
      int i = sign(p.y);
      if (val(airfoil,0,i,0))
 val += fabs(p.y)*(val(s,0,i,0) - val(s,0,0,0));
      else if (val(airfoil,0,-i,0))
 val += fabs(p.y)*(val(s,0,0,0) - val(s,0,-i,0));
    }
    return val;
  }
...
#line 110
static void _stencil_embed_interpolateo (Point point, scalar s,_stencil_undefined * p)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;         
      
  
_stencil_val(airfoil,o_stencil,0,0); _stencil_val(airfoil,0,o_stencil,0); _stencil_val(airfoil,o_stencil,o_stencil,0);{
...
_stencil_val(airfoil,o_stencil,0,0);{
 {_stencil_val(s,o_stencil,0,0); _stencil_val(s,0,0,0);   } 
{_stencil_val(airfoil,o_stencil,0,0);
 {_stencil_val(s,0,0,0);_stencil_val(s, o_stencil,0,0);   } }}
...
_stencil_val(airfoil,0,o_stencil,0);{
 {_stencil_val(s,0,o_stencil,0); _stencil_val(s,0,0,0);   } 
{_stencil_val(airfoil,0,o_stencil,0);
 {_stencil_val(s,0,0,0);_stencil_val(s,0, o_stencil,0);   } }}
...
#line 138
{
    ...
    if (dirichlet) {
      double val;
      dudn.y = dirichlet_gradiento (point, u.y, airfoil, n, p, vb, &val);
    }
    else
      dudn.y = vb;
    if (dudn.y == 1e30)
...
#line 134
static void 
_stencil_embed_gradiento (Point point, vector u,_stencil_undefined * p,_stencil_undefined * n)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES; 
...
_stencil_dirichlet_gradiento (point, u.x, airfoil,NULL ,NULL ,NULL ,NULL ); 
...
_stencil_dirichlet_gradiento (point, u.y, airfoil,NULL ,NULL ,NULL ,NULL ); 
...
#line 161
foreach_stencil (1,{(NonLocal[]){{"Fmus","coord",(void *)&Fmus,NULL,0},{"u","vector",(void *)&u,NULL,0},{"val","double",(void *)&val,NULL,0},{"embed","bid",(void *)&embed,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"mu","vector",(void *)&mu,NULL,0},{"Fps","coord",(void *)&Fps,NULL,0},{"p","scalar",(void *)&p,NULL,0},{"ferr","not implemented yet",(void *)ferr,NULL,1},{"Fn","double",(void *)&Fn,NULL,0},{"sf","vector",(void *)&sf,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 23 \"./../interfaceforce.h\"\nstatic inline real dirichlet_gradiento_y (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.y = - n.y;\n    \n// #line 28\nn.x = - n.x;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(sf.y,0,(n.y > 0.),0))\n      defined = false;\n    \n// #line 32\nif (defined && !val(sf.x,(n.x > 0.),0,0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.y);\n      d[l] = (i - p.y)/n.y;\n      real y1 = p.x + d[l]*n.x;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(sf.y,j,i + (i < 0),0) && val(sf.x,j,i,0) && val(sf.x,j+1,i,0) &&\n   val(cs,j-1,i,0) && val(cs,j,i,0) && val(cs,j+1,i,0))\n v[l] = ((((val(s,j-1,i,0)))*((y1) - 1.) + ((val(s,j+1,i,0)))*((y1) + 1.))*(y1)/2. - ((val(s,j,i,0)))*((y1) - 1.)*((y1) + 1.));\n// # 66 \"./../interfaceforce.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n    d[0] = max(1e-3, fabs(p.y/n.y));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n\n\n\n\n\n// #line 23 \"./../interfaceforce.h\"\nstatic inline real dirichlet_gradiento_x (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.x = - n.x;\n    \n// #line 28\nn.y = - n.y;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(sf.x,(n.x > 0.),0,0))\n      defined = false;\n    \n// #line 32\nif (defined && !val(sf.y,0,(n.y > 0.),0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.x);\n      d[l] = (i - p.x)/n.x;\n      real y1 = p.y + d[l]*n.y;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(sf.x,i + (i < 0),j,0) && val(sf.y,i,j,0) && val(sf.y,i,j+1,0) &&\n   val(cs,i,j-1,0) && val(cs,i,j,0) && val(cs,i,j+1,0))\n v[l] = ((((val(s,i,j-1,0)))*((y1) - 1.) + ((val(s,i,j+1,0)))*((y1) + 1.))*(y1)/2. - ((val(s,i,j,0)))*((y1) - 1.)*((y1) + 1.));\n// # 66 \"./../interfaceforce.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n    d[0] = max(1e-3, fabs(p.x/n.x));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n\n// #line 81 \"./../interfaceforce.h\"\nreal dirichlet_gradiento (Point point, scalar s, scalar cs,\n      coord n, coord p, real bc, inout real  coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n\n  \n    if (fabs(n.x) >= fabs(n.y))\n      return dirichlet_gradiento_x (point, s, cs, n, p, bc, coef);\n    \n// #line 86\nif (fabs(n.y) >= fabs(n.x))\n      return dirichlet_gradiento_y (point, s, cs, n, p, bc, coef);\n// # 97 \"./../interfaceforce.h\"\n  return 1e30;\n}\n\n\n\n// #line 134 \"./../interfaceforce.h\"\nstatic inline\ncoord embed_gradiento (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn;\n   {\n    bool dirichlet = false;\n    real vb = u.x.boundary[embed] (point, point, u.x, &dirichlet);\n\n    if (dirichlet) {\n      real val;\n      dudn.x = dirichlet_gradiento (point, u.x, airfoil, n, p, vb, val);\n    }\n    else\n      dudn.x = vb;\n    if (dudn.x == 1e30)\n      dudn.x = 0.;\n  } \n// #line 138\n{\n    bool dirichlet = false;\n    real vb = u.y.boundary[embed] (point, point, u.y, &dirichlet);\n\n    if (dirichlet) {\n      real val;\n      dudn.y = dirichlet_gradiento (point, u.y, airfoil, n, p, vb, val);\n    }\n    else\n      dudn.y = vb;\n    if (dudn.y == 1e30)\n      dudn.y = 0.;\n  }\n  return dudn;\n}\n@ def not_mpi_compatible()\ndo {\n  if (npe() > 1) {\n    fprintf (ferr, \"%s() is not compatible with MPI (yet)\\n\", __func__);\n    exit (1);\n  }\n} while(0)\n@\n@ define system(command) (pid() == 0 ? system(command) : 0)\n@else\n@ define qstderr() stderr\n@ define qstdout() stdout\n@ define ferr stderr\n@ define fout stdout\n@ define not_mpi_compatible()\n@endif\n\n\n\n\n// #line 93 \"/home/spencer/basilisk/src/common.h\"\nstatic inline void qassert (const char * file, int line, const char * cond) {\n  fprintf (ferr, \"%s:%d: Assertion `%s' failed.\\n\", file, line, cond);\n  abort();\n}\n\n\n// #line 110 \"./../interfaceforce.h\"\nreal embed_interpolateo (Point point, scalar s, coord p)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (!(2 == 2)) qassert (\"./../interfaceforce.h\", 112, \"dimension == 2\");\n  int i = sign(p.x), j = sign(p.y);\n  if (val(airfoil,i,0,0) && val(airfoil,0,j,0) && val(airfoil,i,j,0))\n\n    return ((val(s,0,0,0)*(1. - fabs(p.x)) + val(s,i,0,0)*fabs(p.x))*(1. - fabs(p.y)) +\n     (val(s,0,j,0)*(1. - fabs(p.x)) + val(s,i,j,0)*fabs(p.x))*fabs(p.y));\n  else {\n\n\n    real val = val(s,0,0,0);\n     {\n      int i = sign(p.x);\n      if (val(airfoil,i,0,0))\n val += fabs(p.x)*(val(s,i,0,0) - val(s,0,0,0));\n      else if (val(airfoil,-i,0,0))\n val += fabs(p.x)*(val(s,0,0,0) - val(s,-i,0,0));\n    } \n// #line 122\n{\n      int i = sign(p.y);\n      if (val(airfoil,0,i,0))\n val += fabs(p.y)*(val(s,0,i,0) - val(s,0,0,0));\n      else if (val(airfoil,0,-i,0))\n val += fabs(p.y)*(val(s,0,0,0) - val(s,0,-i,0));\n    }\n    return val;\n  }\n}\n\nOMP(omp declare reduction (+ : coord :\n      omp_out.x += omp_in.x,\n      omp_out.y += omp_in.y,\n      omp_out.z += omp_in.z))\n// # 920 \"/home/spencer/basilisk/src/common.h\"\nvoid normalize (coord * n)\n{\n  real norm = 0.;\n  \n    norm += sq(n->x);\n    \n// #line 924\nnorm += sq(n->y);\n  norm = sqrt(norm);\n  \n    n->x /= norm;\n    \n// #line 927\nn->y /= norm;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"movingcylinder2D-cpp.c\" 2\n// # 1 \"movingcylinder2D.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}\n\n\n\n// #line 101 \"./../interfaceforce.h\"\nreal embed_geometryo (Point point, coord * b, coord * n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  *n = facet_normal (point, airfoil, sf);\n  real alpha = line_alpha (val(airfoil,0,0,0), *n);\n  real area = line_length_center(*n,alpha,b);\n  normalize (n);\n  return area;\n}"," \n// #line 161 \"./../interfaceforce.h\"\n{\n    if (val(c,0,0,0) > 1e-6 && val(c,0,0,0) < 1. - 1e-6) {\n\n      coord n, b;\n      real area = embed_geometryo (point, &b, &n);\n      area *= pow (Delta, 2 - 1);\n\n      Fn = area*embed_interpolateo (point, p, b);\n      \n Fps.x -= Fn*n.x;\n \n// #line 170\nFps.y -= Fn*n.y;\n\n      if (constant(mu.x) != 0.) {\n real mua = 0., fa = 0.;\n  {\n   mua += val(mu.x,0,0,0) + val(mu.x,1,0,0);\n   fa += val(fm.x,0,0,0) + val(fm.x,1,0,0);\n } \n// #line 174\n{\n   mua += val(mu.y,0,0,0) + val(mu.y,0,1,0);\n   fa += val(fm.y,0,0,0) + val(fm.y,0,1,0);\n }\n mua /= fa;\n if (!(2 == 2)) qassert (\"./../interfaceforce.h\", 179, \"dimension == 2\");\n coord dudn = embed_gradiento (point, u, b, n);\n \n   Fmus.x -= area*mua*(dudn.x*(sq(n.x) + 1.) + dudn.y*n.x*n.y);\n   \n// #line 182\nFmus.y -= area*mua*(dudn.y*(sq(n.y) + 1.) + dudn.x*n.y*n.x);\n      }\n    }\n  }"}) {
_stencil_val(c,0,0,0); _stencil_val(c,0,0,0); {    

      
       _stencil_embed_geometryo (point,NULL ,NULL );
            

_stencil_embed_interpolateo (point, p,NULL ); 
...
#line 177
  ...
  _stencil_embed_gradiento (point, u,NULL ,NULL );
...
Fmus.y -= area*mua*(dudn.y*(sq(n.y) + 1.) + dudn.x*n.y*n.x);
  ...
  }end_foreach();}}else {_coord _const_fm={_constant[fm.x.i-_NVARMAX],_constant[fm.y.i-_NVARMAX]};NOT_UNUSED(_const_fm);
...
#line 190
static void _stencil_embed_vorticityo (Point point, vector u,_stencil_undefined * p,_stencil_undefined * n)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;  
   _stencil_embed_gradiento (point, u,NULL ,NULL );

  return   ;
}
#line 8 "movingcylinder2D.c"
#line 1 "curvature.h"
...
#line 289 "/home/spencer/basilisk/src/heights.h"
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
 ...
 val(h,0,0,0) = val(h,i,0,0) + i;
  ...
  if (complete)
    return;
#line 317 "/home/spencer/basilisk/src/heights.h"
...
#line 352 "/home/spencer/basilisk/src/heights.h"
}
...
{tracing("heights","/home/spencer/basilisk/src/heights.h",360);
...
#line 399 "/home/spencer/basilisk/src/heights.h"
      {foreach_level (l - 1)
 { {
...
end_tracing("heights","/home/spencer/basilisk/src/heights.h",447);}
...
#line 1 "utils.h"
#line 2 "/home/spencer/basilisk/src/parabola.h"
...
#line 643 "/home/spencer/basilisk/src/curvature.h"
  { cstats _ret= (cstats){sh, sf, sa, sc};delete((scalar*)((scalar[]){k,{-1}}));if((ch).x.i<=0)delete((scalar*)((vector[]){h,{{-1},{-1}}}));{end_tracing("curvature","/home/spencer/basilisk/src/curvature.h",643);return _ret;}}delete((scalar*)((scalar[]){k,{-1}}));
...
hp += (o.y + Delta*c.y - Z.y)*G.y;
 ...
 val(pos,0,0,0) = hp;
      ...
      val(pos,0,0,0) = 1e30;
  }end_foreach();}if((fh).x.i<=0)delete((scalar*)((vector[]){h,{{-1},{-1}}}));
#line 790 "/home/spencer/basilisk/src/curvature.h"
}
#line 9 "movingcylinder2D.c"
#line 1 "view.h"
...
double SDF (double x, double y) {
   return - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);
}
...
#line 106
      static int moving_cylinder(const int i,const double t,Event *_ev){tracing("moving_cylinder","movingcylinder2D.c",106); {
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 107 \"movingcylinder2D.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);"}) {_stencil_val_a(phi,0,0,0);           }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);end_foreach_vertex();} fractions (phi, airfoil, sf
#line 122 "/home/spencer/basilisk/src/fractions.h"
, 0.
#line 107 "movingcylinder2D.c"
);delete((scalar*)((scalar[]){phi,{-1}})); } while(0);
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 108 \"movingcylinder2D.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);"}) {_stencil_val_a(phi,0,0,0);           }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);end_foreach_vertex();} fractions (phi, ref, rf
#line 122 "/home/spencer/basilisk/src/fractions.h"
, 0.
#line 108 "movingcylinder2D.c"
);delete((scalar*)((scalar[]){phi,{-1}})); } while(0);
  ...
  normal_vector(airfoil, nv);
    foreach_stencil(1,{(NonLocal[]){{"airfoil","scalar",(void *)&airfoil,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"nv","vector",(void *)&nv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n\n// #line 43 \"movingcylinder2D.c\"\nreal SDF (real x, real y) {\n   return - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);\n}"," \n// #line 113 \"movingcylinder2D.c\"\n{\n      real lambda = fabs(val(nv.x,0,0,0)) + fabs(val(nv.y,0,0,0));\n      if (lambda != 0.) {\n        real eta = 0.065*(1 - sq(lambda)) + 0.39;\n        real num = - SDF (x,y);\n        real den = lambda * eta * sqrt(2) * Delta;\n        val_out_(airfoil,0,0,0) = den != 0? 0.5*(1 - tanh (num/den)): val(airfoil,0,0,0);\n      }\n    }"}) {     
      _stencil_val(nv.y,0,0,0);_stencil_val(nv.x,0,0,0); 
{                     
...
#line 113
foreach() {
      double lambda = fabs(val(nv.x,0,0,0)) + fabs(val(nv.y,0,0,0));
      if (lambda != 0.) {
        double eta = 0.065*(1 - sq(lambda)) + 0.39;
        double num = - SDF (x,y);
        double den = lambda * eta * sqrt(2) * Delta;
        val(airfoil,0,0,0) = den != 0? 0.5*(1 - tanh (num/den)): val(airfoil,0,0,0);
      }
    }end_foreach();}delete((scalar*)((vector[]){nv,{{-1},{-1}}}));
  }

}{end_tracing("moving_cylinder","movingcylinder2D.c",124);return 0;}end_tracing("moving_cylinder","movingcylinder2D.c",124);}

static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0)!=0;*ip=i;*tp=t;return ret;}


#line 126
      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","movingcylinder2D.c",126); {
  { {foreach_cell_post(!is_leaf(cell)) { if (is_leaf(cell)) { int bid = (y > 6 ? top: y < -6 ? bottom : -1); if (bid >= 0) cell.pid = - bid - 1; } else { int pid = -1; {foreach_child() if (cell.pid >= 0 || pid < 0) pid = cell.pid;end_foreach_child()} cell.pid = pid; if (pid < 0) { cell.flags |= leaf; decrement_neighbors (point); } } }end_foreach_cell_post();} ((Tree *)grid)->dirty = true; };
}{end_tracing("init_0","movingcylinder2D.c",128);return 0;}end_tracing("init_0","movingcylinder2D.c",128);}
...
#line 131
      static int properties_0(const int i,const double t,Event *_ev){tracing("properties_0","movingcylinder2D.c",131); {
  if(!is_constant(fm.x)){
  
#line 132
foreach_face_stencil(1,{(NonLocal[]){{"Re","double",(void *)&Re,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 132 \"movingcylinder2D.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(0.5)/(Re);}end_is_face_x()\n// #line 132\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(0.5)/(Re);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 132
foreach_face_stencil(1,{(NonLocal[]){{"Re","double",(void *)&Re,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 132 \"movingcylinder2D.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(0.5)/(Re);}end_is_face_x()\n// #line 132\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(0.5)/(Re);}end_is_face_y()}"}){_stencil_is_face_x(){
...
}{end_tracing("properties_0","movingcylinder2D.c",135);return 0;}end_tracing("properties_0","movingcylinder2D.c",135);}
...
#line 138
      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","movingcylinder2D.c",138);{
  coord Fp, Fmu = {0,0};
  ...
  double E = 0;
  double E_p = 0;
  boundary_internal ((scalar *)((scalar[]){u.x, u.y,{-1}}), "movingcylinder2D.c", 147);
  scalar  omega=new_scalar("omega");
  vorticity (u , omega);
  if(!is_constant(cm)){
  
#line 150
foreach_stencil(1,{(NonLocal[]){{"E","double",(void *)&E,NULL,0},{"u","vector",(void *)&u,NULL,0},{"val","double",(void *)&val,NULL,0},{"embed","bid",(void *)&embed,NULL,0},{"sf","vector",(void *)&sf,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"E_p","double",(void *)&E_p,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"omega","scalar",(void *)&omega,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 23 \"./../interfaceforce.h\"\nstatic inline real dirichlet_gradiento_y (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.y = - n.y;\n    \n// #line 28\nn.x = - n.x;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(sf.y,0,(n.y > 0.),0))\n      defined = false;\n    \n// #line 32\nif (defined && !val(sf.x,(n.x > 0.),0,0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.y);\n      d[l] = (i - p.y)/n.y;\n      real y1 = p.x + d[l]*n.x;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(sf.y,j,i + (i < 0),0) && val(sf.x,j,i,0) && val(sf.x,j+1,i,0) &&\n   val(cs,j-1,i,0) && val(cs,j,i,0) && val(cs,j+1,i,0))\n v[l] = ((((val(s,j-1,i,0)))*((y1) - 1.) + ((val(s,j+1,i,0)))*((y1) + 1.))*(y1)/2. - ((val(s,j,i,0)))*((y1) - 1.)*((y1) + 1.));\n// # 66 \"./../interfaceforce.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n    d[0] = max(1e-3, fabs(p.y/n.y));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n\n\n\n\n\n// #line 23 \"./../interfaceforce.h\"\nstatic inline real dirichlet_gradiento_x (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.x = - n.x;\n    \n// #line 28\nn.y = - n.y;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(sf.x,(n.x > 0.),0,0))\n      defined = false;\n    \n// #line 32\nif (defined && !val(sf.y,0,(n.y > 0.),0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.x);\n      d[l] = (i - p.x)/n.x;\n      real y1 = p.y + d[l]*n.y;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(sf.x,i + (i < 0),j,0) && val(sf.y,i,j,0) && val(sf.y,i,j+1,0) &&\n   val(cs,i,j-1,0) && val(cs,i,j,0) && val(cs,i,j+1,0))\n v[l] = ((((val(s,i,j-1,0)))*((y1) - 1.) + ((val(s,i,j+1,0)))*((y1) + 1.))*(y1)/2. - ((val(s,i,j,0)))*((y1) - 1.)*((y1) + 1.));\n// # 66 \"./../interfaceforce.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n    d[0] = max(1e-3, fabs(p.x/n.x));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n\n// #line 81 \"./../interfaceforce.h\"\nreal dirichlet_gradiento (Point point, scalar s, scalar cs,\n      coord n, coord p, real bc, inout real  coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n\n  \n    if (fabs(n.x) >= fabs(n.y))\n      return dirichlet_gradiento_x (point, s, cs, n, p, bc, coef);\n    \n// #line 86\nif (fabs(n.y) >= fabs(n.x))\n      return dirichlet_gradiento_y (point, s, cs, n, p, bc, coef);\n// # 97 \"./../interfaceforce.h\"\n  return 1e30;\n}\n\n\n\n// #line 134 \"./../interfaceforce.h\"\nstatic inline\ncoord embed_gradiento (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn;\n   {\n    bool dirichlet = false;\n    real vb = u.x.boundary[embed] (point, point, u.x, &dirichlet);\n\n    if (dirichlet) {\n      real val;\n      dudn.x = dirichlet_gradiento (point, u.x, airfoil, n, p, vb, val);\n    }\n    else\n      dudn.x = vb;\n    if (dudn.x == 1e30)\n      dudn.x = 0.;\n  } \n// #line 138\n{\n    bool dirichlet = false;\n    real vb = u.y.boundary[embed] (point, point, u.y, &dirichlet);\n\n    if (dirichlet) {\n      real val;\n      dudn.y = dirichlet_gradiento (point, u.y, airfoil, n, p, vb, val);\n    }\n    else\n      dudn.y = vb;\n    if (dudn.y == 1e30)\n      dudn.y = 0.;\n  }\n  return dudn;\n}\n\n\n// #line 190 \"./../interfaceforce.h\"\nreal embed_vorticityo (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn = embed_gradiento (point, u, p, n);\n\n  return dudn.y*n.x - dudn.x*n.y;\n}\n\nOMP(omp declare reduction (+ : coord :\n      omp_out.x += omp_in.x,\n      omp_out.y += omp_in.y,\n      omp_out.z += omp_in.z))\n// # 920 \"/home/spencer/basilisk/src/common.h\"\nvoid normalize (coord * n)\n{\n  real norm = 0.;\n  \n    norm += sq(n->x);\n    \n// #line 924\nnorm += sq(n->y);\n  norm = sqrt(norm);\n  \n    n->x /= norm;\n    \n// #line 927\nn->y /= norm;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"movingcylinder2D-cpp.c\" 2\n// # 1 \"movingcylinder2D.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}\n\n\n\n// #line 101 \"./../interfaceforce.h\"\nreal embed_geometryo (Point point, coord * b, coord * n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  *n = facet_normal (point, airfoil, sf);\n  real alpha = line_alpha (val(airfoil,0,0,0), *n);\n  real area = line_length_center(*n,alpha,b);\n  normalize (n);\n  return area;\n}","\n// #line 150 \"movingcylinder2D.c\"\n{\n    real vort = val(omega,0,0,0);\n    real area = (sq(Delta)*val(cm,0,0,0));\n    E_p += sq(vort);\n    if (val(airfoil,0,0,0) < 1. && val(airfoil,0,0,0) > 0){\n      coord b, n;\n      area *= embed_geometryo (point, &b, &n);\n      vort = embed_vorticityo (point, u, b, n);\n    }\n    E += area*sq(vort);\n  }"}){  
     _stencil_val(omega,0,0,0);   
    _stencil_val(cm,0,0,0); 
     
_stencil_val(airfoil,0,0,0); _stencil_val(airfoil,0,0,0);{  
       
_stencil_embed_geometryo (point,NULL ,NULL );
        _stencil_embed_vorticityo (point, u,NULL ,NULL );
...
#line 150
foreach(){
    double vort = val(omega,0,0,0);
    double area = (sq(Delta)*val(cm,0,0,0));
    E_p += sq(vort);
    if (val(airfoil,0,0,0) < 1. && val(airfoil,0,0,0) > 0){
      coord b, n;
      area *= embed_geometryo (point, &b, &n);
...
#line 150
foreach_stencil(1,{(NonLocal[]){{"E","double",(void *)&E,NULL,0},{"u","vector",(void *)&u,NULL,0},{"val","double",(void *)&val,NULL,0},{"embed","bid",(void *)&embed,NULL,0},{"sf","vector",(void *)&sf,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"E_p","double",(void *)&E_p,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"omega","scalar",(void *)&omega,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n\n// #line 23 \"./../interfaceforce.h\"\nstatic inline real dirichlet_gradiento_y (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.y = - n.y;\n    \n// #line 28\nn.x = - n.x;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(sf.y,0,(n.y > 0.),0))\n      defined = false;\n    \n// #line 32\nif (defined && !val(sf.x,(n.x > 0.),0,0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.y);\n      d[l] = (i - p.y)/n.y;\n      real y1 = p.x + d[l]*n.x;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(sf.y,j,i + (i < 0),0) && val(sf.x,j,i,0) && val(sf.x,j+1,i,0) &&\n   val(cs,j-1,i,0) && val(cs,j,i,0) && val(cs,j+1,i,0))\n v[l] = ((((val(s,j-1,i,0)))*((y1) - 1.) + ((val(s,j+1,i,0)))*((y1) + 1.))*(y1)/2. - ((val(s,j,i,0)))*((y1) - 1.)*((y1) + 1.));\n// # 66 \"./../interfaceforce.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n    d[0] = max(1e-3, fabs(p.y/n.y));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n\n\n\n\n\n// #line 23 \"./../interfaceforce.h\"\nstatic inline real dirichlet_gradiento_x (Point point, scalar s, scalar cs,\n        coord n, coord p, real bc,\n        real * coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  \n    n.x = - n.x;\n    \n// #line 28\nn.y = - n.y;\n  real d[2], v[2] = {1e30,1e30};\n  bool defined = true;\n  \n    if (defined && !val(sf.x,(n.x > 0.),0,0))\n      defined = false;\n    \n// #line 32\nif (defined && !val(sf.y,0,(n.y > 0.),0))\n      defined = false;\n  if (defined)\n    for (int l = 0; l <= 1; l++) {\n      int i = (l + 1)*sign(n.x);\n      d[l] = (i - p.x)/n.x;\n      real y1 = p.y + d[l]*n.y;\n      int j = y1 > 0.5 ? 1 : y1 < -0.5 ? -1 : 0;\n      y1 -= j;\n\n      if (val(sf.x,i + (i < 0),j,0) && val(sf.y,i,j,0) && val(sf.y,i,j+1,0) &&\n   val(cs,i,j-1,0) && val(cs,i,j,0) && val(cs,i,j+1,0))\n v[l] = ((((val(s,i,j-1,0)))*((y1) - 1.) + ((val(s,i,j+1,0)))*((y1) + 1.))*(y1)/2. - ((val(s,i,j,0)))*((y1) - 1.)*((y1) + 1.));\n// # 66 \"./../interfaceforce.h\"\n      else\n break;\n    }\n  if (v[0] == 1e30) {\n    d[0] = max(1e-3, fabs(p.x/n.x));\n    *coef = - 1./(d[0]*Delta);\n    return bc/(d[0]*Delta);\n  }\n  *coef = 0.;\n  if (v[1] != 1e30)\n    return (d[1]*(bc - v[0])/d[0] - d[0]*(bc - v[1])/d[1])/((d[1] - d[0])*Delta);\n  return (bc - v[0])/(d[0]*Delta);\n}\n\n\n\n// #line 81 \"./../interfaceforce.h\"\nreal dirichlet_gradiento (Point point, scalar s, scalar cs,\n      coord n, coord p, real bc, inout real  coef)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n\n  \n    if (fabs(n.x) >= fabs(n.y))\n      return dirichlet_gradiento_x (point, s, cs, n, p, bc, coef);\n    \n// #line 86\nif (fabs(n.y) >= fabs(n.x))\n      return dirichlet_gradiento_y (point, s, cs, n, p, bc, coef);\n// # 97 \"./../interfaceforce.h\"\n  return 1e30;\n}\n\n\n\n// #line 134 \"./../interfaceforce.h\"\nstatic inline\ncoord embed_gradiento (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn;\n   {\n    bool dirichlet = false;\n    real vb = u.x.boundary[embed] (point, point, u.x, &dirichlet);\n\n    if (dirichlet) {\n      real val;\n      dudn.x = dirichlet_gradiento (point, u.x, airfoil, n, p, vb, val);\n    }\n    else\n      dudn.x = vb;\n    if (dudn.x == 1e30)\n      dudn.x = 0.;\n  } \n// #line 138\n{\n    bool dirichlet = false;\n    real vb = u.y.boundary[embed] (point, point, u.y, &dirichlet);\n\n    if (dirichlet) {\n      real val;\n      dudn.y = dirichlet_gradiento (point, u.y, airfoil, n, p, vb, val);\n    }\n    else\n      dudn.y = vb;\n    if (dudn.y == 1e30)\n      dudn.y = 0.;\n  }\n  return dudn;\n}\n\n\n// #line 190 \"./../interfaceforce.h\"\nreal embed_vorticityo (Point point, vector u, coord p, coord n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord dudn = embed_gradiento (point, u, p, n);\n\n  return dudn.y*n.x - dudn.x*n.y;\n}\n\nOMP(omp declare reduction (+ : coord :\n      omp_out.x += omp_in.x,\n      omp_out.y += omp_in.y,\n      omp_out.z += omp_in.z))\n// # 920 \"/home/spencer/basilisk/src/common.h\"\nvoid normalize (coord * n)\n{\n  real norm = 0.;\n  \n    norm += sq(n->x);\n    \n// #line 924\nnorm += sq(n->y);\n  norm = sqrt(norm);\n  \n    n->x /= norm;\n    \n// #line 927\nn->y /= norm;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"movingcylinder2D-cpp.c\" 2\n// # 1 \"movingcylinder2D.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}\n\n\n\n// #line 101 \"./../interfaceforce.h\"\nreal embed_geometryo (Point point, coord * b, coord * n)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  *n = facet_normal (point, airfoil, sf);\n  real alpha = line_alpha (val(airfoil,0,0,0), *n);\n  real area = line_length_center(*n,alpha,b);\n  normalize (n);\n  return area;\n}","\n// #line 150 \"movingcylinder2D.c\"\n{\n    real vort = val(omega,0,0,0);\n    real area = (sq(Delta)*_const_cm);\n    E_p += sq(vort);\n    if (val(airfoil,0,0,0) < 1. && val(airfoil,0,0,0) > 0){\n      coord b, n;\n      area *= embed_geometryo (point, &b, &n);\n      vort = embed_vorticityo (point, u, b, n);\n    }\n    E += area*sq(vort);\n  }"}){  
     _stencil_val(omega,0,0,0);
; 
...
foreach(){
    double vort = val(omega,0,0,0);
    double area = (sq(Delta)*_const_cm);
    E_p += sq(vort);
    if (val(airfoil,0,0,0) < 1. && val(airfoil,0,0,0) > 0){
      coord b, n;
      area *= embed_geometryo (point, &b, &n);
  ...
  fprintf (ferr, "%d %g %d %d %d %d %d %g %g %g %g\n",
    i, t, j, mgp.i, mgp.nrelax, mgu.i, mgu.nrelax, CD, CL, E, E_p);delete((scalar*)((scalar[]){omega,{-1}}));

}{end_tracing("logfile","movingcylinder2D.c",165);return 0;}end_tracing("logfile","movingcylinder2D.c",165);}
...
#line 168
      static int snapshot(const int i,const double t,Event *_ev){tracing("snapshot","movingcylinder2D.c",168); {
  scalar  omega=new_scalar("omega");
  vorticity (u, omega);
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 171 \"movingcylinder2D.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);"}) {_stencil_val_a(phi,0,0,0);           }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x) - sq(y - ci.y) + sq(0.5/2);end_foreach_vertex();} fractions (phi, ref, rf
#line 122 "/home/spencer/basilisk/src/fractions.h"
, 0.
#line 171 "movingcylinder2D.c"
);delete((scalar*)((scalar[]){phi,{-1}})); } while(0);
...
}{end_tracing("snapshot","movingcylinder2D.c",181);return 0;}end_tracing("snapshot","movingcylinder2D.c",181);}

static int adapt_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++)!=0;*ip=i;*tp=t;return ret;}


#line 183
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","movingcylinder2D.c",183); {
  adapt_wavelet (
#line 184 "/home/spencer/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 184
)
#line 184 "movingcylinder2D.c"
((scalar[]){airfoil,u.x,u.y,{-1}}), (double[]){1.e-4,3e-4,3e-4}
, 10, 2
#line 176 "/home/spencer/basilisk/src/grid/tree-common.h"
, 
all
#line 185 "movingcylinder2D.c"
);
}{end_tracing("adapt_0","movingcylinder2D.c",186);return 0;}end_tracing("adapt_0","movingcylinder2D.c",186);}

static int profile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = t_end)!=0;*ip=i;*tp=t;return ret;}


#line 188
      static int profile(const int i,const double t,Event *_ev){tracing("profile","movingcylinder2D.c",188); {
  int k = 0;
  double delta = 15/(pow(2,10));
  char name[80];

  sprintf (name, "vprofx1-%d", j);
  FILE * fv = fopen(name, "w");
  for(double i = 0; i <= 6; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"fv","not implemented yet",(void *)fv,NULL,1},{"k","int",(void *)&k,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 196 \"movingcylinder2D.c\"\n{\n      if (val(airfoil,0,0,0) > 0 && val(airfoil,0,0,0) < 1)\n        k = 2.;\n      else if (val(airfoil,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv, \"%d %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0));\n    }"}) {
_stencil_val(airfoil,0,0,0); _stencil_val(airfoil,0,0,0);{ 
...
foreach_point (4.8125, i) {
 ...
 k = 0.;
  ...
  sprintf (name, "vprofx2-%d", j);
  FILE * fv1 = fopen(name, "w");
  for(double i = 0; i <= 6; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"fv1","not implemented yet",(void *)fv1,NULL,1},{"k","int",(void *)&k,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 212 \"movingcylinder2D.c\"\n{\n      if (val(airfoil,0,0,0) > 0 && val(airfoil,0,0,0) < 1)\n        k = 2.;\n      else if (val(airfoil,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv1, \"%d %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0));\n    }"}) {
_stencil_val(airfoil,0,0,0); _stencil_val(airfoil,0,0,0);{ 
...
foreach_point (5, i) {
 ...
 k = 0.;
  ...
  sprintf (name, "vprofx3-%d", j);
  FILE * fv2 = fopen(name, "w");
  for(double i = 0; i <= 6; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"fv2","not implemented yet",(void *)fv2,NULL,1},{"k","int",(void *)&k,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 228 \"movingcylinder2D.c\"\n{\n      if (val(airfoil,0,0,0) > 0 && val(airfoil,0,0,0) < 1)\n        k = 2.;\n      else if (val(airfoil,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv2, \"%d %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0));\n    }"}) {
_stencil_val(airfoil,0,0,0); _stencil_val(airfoil,0,0,0);{ 
...
foreach_point (10, i) {
 ...
 k = 0.;
  ...
  sprintf (name, "vprofy1-%d", j);
  FILE * fv3 = fopen(name, "w");
  for(double i = 0; i <= 15; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"fv3","not implemented yet",(void *)fv3,NULL,1},{"k","int",(void *)&k,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 244 \"movingcylinder2D.c\"\n{\n      if (val(airfoil,0,0,0) > 0 && val(airfoil,0,0,0) < 1)\n        k = 2.;\n      else if (val(airfoil,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv3, \"%d %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0));\n    }"}) {
_stencil_val(airfoil,0,0,0); _stencil_val(airfoil,0,0,0);{ 
...
foreach_point (i, 3) {
 ...
 k = 0.;
  ...
  sprintf (name, "vprofy2-%d", j);
  FILE * fv4 = fopen(name, "w");
  for(double i = 0; i <= 15; i += delta) {
    foreach_point_stencil (1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"fv4","not implemented yet",(void *)fv4,NULL,1},{"k","int",(void *)&k,NULL,0},{"airfoil","scalar",(void *)&airfoil,NULL,0},{"i","double",(void *)&i,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 260 \"movingcylinder2D.c\"\n{\n      if (val(airfoil,0,0,0) > 0 && val(airfoil,0,0,0) < 1)\n        k = 2.;\n      else if (val(airfoil,0,0,0) == 1)\n k = 1.;\n      else\n k = 0.;\n      fprintf (fv4, \"%d %g %g %g %g\\n\", k, x, y, val(u.x,0,0,0), val(u.y,0,0,0));\n    }"}) {
_stencil_val(airfoil,0,0,0); _stencil_val(airfoil,0,0,0);{ 
...
}{end_tracing("profile","movingcylinder2D.c",273);return 0;}end_tracing("profile","movingcylinder2D.c",273);}

static int stop_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = t_end)!=0;*ip=i;*tp=t;return ret;}


#line 275
      static int stop(const int i,const double t,Event *_ev){tracing("stop","movingcylinder2D.c",275); {
  static FILE * fp =NULL;if(!fp||i==0)fp=pid()>0?fopen("/dev/null","w"): fopen("perf", "w");
  timing s = timer_timing (perf.gt, iter, perf.tnc, NULL);
  fprintf (fp, "%d\t%g\t%d\t%g\n", j, s.real, i, s.speed);
  fflush (fp);
  {end_tracing("stop","movingcylinder2D.c",280);return 1;}
}{end_tracing("stop","movingcylinder2D.c",281);return 0;}end_tracing("stop","movingcylinder2D.c",281);}
#line 2 "ast/init_solver.h"

static void _init_solver (void)
{
  void init_solver();
datasize=21*sizeof(double);
...
#line 126 "/home/spencer/basilisk/src/navier-stokes/centered.h"
event_register((Event){0,1,defaults_1,{defaults_1_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/navier-stokes/centered.h",126,"defaults"});  
#line 187
...
#line 7 "/home/spencer/basilisk/src/navier-stokes/perfs.h"
event_register((Event){0,1,perfs,{perfs_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/navier-stokes/perfs.h",7,"perfs"});  
#line 24
event_register((Event){0,1,perf_plot,{perf_plot_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/navier-stokes/perfs.h",24,"perf_plot"});  
#line 106 "movingcylinder2D.c"
event_register((Event){0,1,moving_cylinder,{moving_cylinder_expr0},((int *)0),((double *)0),"movingcylinder2D.c",106,"moving_cylinder"});  
#line 126
event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"movingcylinder2D.c",126,"init"});  
#line 138
event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"movingcylinder2D.c",138,"logfile"});  
#line 168
event_register((Event){0,1,snapshot,{snapshot_expr0},((int *)0),((double *)0),"movingcylinder2D.c",168,"snapshot"});  
#line 188
event_register((Event){0,1,profile,{profile_expr0},((int *)0),((double *)0),"movingcylinder2D.c",188,"profile"});  
#line 275
event_register((Event){0,1,stop,{stop_expr0},((int *)0),((double *)0),"movingcylinder2D.c",275,"stop"});
...
event_register((Event){0,1,vof,{vof_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/navier-stokes/centered.h",234,"vof"});  
...
#line 14 "./../immersed.h"
event_register((Event){0,1,end_timestep_0,{end_timestep_0_expr0},((int *)0),((double *)0),"./../immersed.h",14,"end_timestep"});  
#line 131 "movingcylinder2D.c"
event_register((Event){0,1,properties_0,{properties_0_expr0},((int *)0),((double *)0),"movingcylinder2D.c",131,"properties"});  
#line 183
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"movingcylinder2D.c",183,"adapt"});

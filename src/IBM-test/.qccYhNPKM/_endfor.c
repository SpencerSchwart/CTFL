# 0 "cylinder-oscv2-cpp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "cylinder-oscv2-cpp.c"
@if 700 < 700
  @undef 700
  @define 700 700
@endif
...
double scalar_bilinear_interpolation (Point point, scalar p, coord pc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  double pci;
  double xc = pc.x;
  double yc = pc.y;
...
#line 50
static void _stencil_scalar_bilinear_interpolation (Point point, scalar p,_stencil_undefined * pc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;                           
...
bool empty_neighbor (Point point, coord * pc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  coord pc_temp;
...
#line 88
static void _stencil_empty_neighbor (Point point,_stencil_undefined * pc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;   
...
#line 133
      static int solid_force(const int i,const double t,Event *_ev){tracing("solid_force","./../immersed.h",0); {
  coord uc, pc;
...
{_stencil_empty_neighbor(point,NULL );{ {   
...
#line 186
{
 ...
 val(Pc.y,0,0,0) = 0;
  ...
  boundary_internal ((scalar *)((scalar[]){Fc.x,Fc.y, Pc.x, Pc.y, vof,{-1}}), "./../immersed.h", 0);
...
#line 197
foreach_stencil(1,{(NonLocal[]){{"fc","vector",(void *)&fc,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"Pc","vector",(void *)&Pc,NULL,0},{"Fd","vector",(void *)&Fd,NULL,0},{"maxlevel","int",(void *)&maxlevel,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 106 \"./../immersed.h\"\nvoid printx (Point point, int j) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n// # 130 \"./../immersed.h\"\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}"),_(" \n// #line 197 \"./../immersed.h\"\n{\n    coord sum = {0};\n    if (level == maxlevel) {\n      real x1 = x;\n      real y1 = y;\n      real delta_h;\n      {foreach_neighbor() {\n        if (val(Fd.x,0,0,0) && level == maxlevel) {\n          delta_h = delta_func(x1, y1, val(Pc.x,0,0,0), val(Pc.y,0,0,0), Delta);\n          \n            sum.x += val(Fd.x,0,0,0) * delta_h * (sq(Delta)*val(cm,0,0,0));\n            \n// #line 207\nsum.y += val(Fd.y,0,0,0) * delta_h * (sq(Delta)*val(cm,0,0,0));\n }\n      }end_foreach_neighbor()}\n    }\n    \n      val_out_(fc.x,0,0,0) = sum.x;\n      \n// #line 212\nval_out_(fc.y,0,0,0) = sum.y;\n\n        printx (point, 2);\n  }")}) {   
...
#line 197
foreach_stencil(1,{(NonLocal[]){{"fc","vector",(void *)&fc,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"Pc","vector",(void *)&Pc,NULL,0},{"Fd","vector",(void *)&Fd,NULL,0},{"maxlevel","int",(void *)&maxlevel,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 106 \"./../immersed.h\"\nvoid printx (Point point, int j) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n// # 130 \"./../immersed.h\"\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}"),_(" \n// #line 197 \"./../immersed.h\"\n{\n    coord sum = {0};\n    if (level == maxlevel) {\n      real x1 = x;\n      real y1 = y;\n      real delta_h;\n      {foreach_neighbor() {\n        if (val(Fd.x,0,0,0) && level == maxlevel) {\n          delta_h = delta_func(x1, y1, val(Pc.x,0,0,0), val(Pc.y,0,0,0), Delta);\n          \n            sum.x += val(Fd.x,0,0,0) * delta_h * (sq(Delta)*_const_cm);\n            \n// #line 207\nsum.y += val(Fd.y,0,0,0) * delta_h * (sq(Delta)*_const_cm);\n }\n      }end_foreach_neighbor()}\n    }\n    \n      val_out_(fc.x,0,0,0) = sum.x;\n      \n// #line 212\nval_out_(fc.y,0,0,0) = sum.y;\n\n        printx (point, 2);\n  }")}) {   
...
#line 221
foreach_stencil(1,{(NonLocal[]){{"den","coord",(void *)&den,NULL,0},{"Fd","vector",(void *)&Fd,NULL,0},{"num","coord",(void *)&num,NULL,0},{"Fc","vector",(void *)&Fc,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"maxlevel","int",(void *)&maxlevel,NULL,0},{"Pc","vector",(void *)&Pc,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 106 \"./../immersed.h\"\nvoid printx (Point point, int j) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n// # 130 \"./../immersed.h\"\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}"),_(" \n// #line 221 \"./../immersed.h\"\n{\n    coord pc, sum = {0};\n    if (val(Pc.x,0,0,0)) {\n      real delta_sum = 0;\n      pc.x = val(Pc.x,0,0,0);\n      pc.y = val(Pc.y,0,0,0);\n      {foreach_neighbor() {\n        real delta_f = level == maxlevel? delta_func (x, y, pc.x, pc.y, Delta): 0;\n        \n   sum.x += val(fc.x,0,0,0) * delta_f * (sq(Delta)*val(cm,0,0,0));\n   \n// #line 230\nsum.y += val(fc.y,0,0,0) * delta_f * (sq(Delta)*val(cm,0,0,0));\n\n      }end_foreach_neighbor()}\n       {\n        val_out_(Fc.x,0,0,0) = sum.x;\n        num.x += (val(Fc.x,0,0,0) * val(Fd.x,0,0,0));\n        den.x += (sq(val(Fc.x,0,0,0)));\n\n    } \n// #line 233\n{\n        val_out_(Fc.y,0,0,0) = sum.y;\n        num.y += (val(Fc.y,0,0,0) * val(Fd.y,0,0,0));\n        den.y += (sq(val(Fc.y,0,0,0)));\n\n    }\n    }\n    printx (point, 3);\n  }")}) {    
...
#line 221
foreach_stencil(1,{(NonLocal[]){{"den","coord",(void *)&den,NULL,0},{"Fd","vector",(void *)&Fd,NULL,0},{"num","coord",(void *)&num,NULL,0},{"Fc","vector",(void *)&Fc,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"maxlevel","int",(void *)&maxlevel,NULL,0},{"Pc","vector",(void *)&Pc,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 106 \"./../immersed.h\"\nvoid printx (Point point, int j) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n// # 130 \"./../immersed.h\"\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}"),_(" \n// #line 221 \"./../immersed.h\"\n{\n    coord pc, sum = {0};\n    if (val(Pc.x,0,0,0)) {\n      real delta_sum = 0;\n      pc.x = val(Pc.x,0,0,0);\n      pc.y = val(Pc.y,0,0,0);\n      {foreach_neighbor() {\n        real delta_f = level == maxlevel? delta_func (x, y, pc.x, pc.y, Delta): 0;\n        \n   sum.x += val(fc.x,0,0,0) * delta_f * (sq(Delta)*_const_cm);\n   \n// #line 230\nsum.y += val(fc.y,0,0,0) * delta_f * (sq(Delta)*_const_cm);\n\n      }end_foreach_neighbor()}\n       {\n        val_out_(Fc.x,0,0,0) = sum.x;\n        num.x += (val(Fc.x,0,0,0) * val(Fd.x,0,0,0));\n        den.x += (sq(val(Fc.x,0,0,0)));\n\n    } \n// #line 233\n{\n        val_out_(Fc.y,0,0,0) = sum.y;\n        num.y += (val(Fc.y,0,0,0) * val(Fd.y,0,0,0));\n        den.y += (sq(val(Fc.y,0,0,0)));\n\n    }\n    }\n    printx (point, 3);\n  }")}) {    
...
#line 247
foreach_stencil(1,{(NonLocal[]){{"correct","coord",(void *)&correct,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"u","vector",(void *)&u,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"Fd","vector",(void *)&Fd,NULL,0},{"Pc","vector",(void *)&Pc,NULL,0},{"maxlevel","int",(void *)&maxlevel,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 106 \"./../immersed.h\"\nvoid printx (Point point, int j) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n// # 130 \"./../immersed.h\"\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}"),_(" \n// #line 247 \"./../immersed.h\"\n{\n    real delta_sum = 0.;\n    coord sum = {0};\n    if (level == maxlevel) {\n      real x1 = x;\n      real y1 = y;\n      real delta_h;\n      {foreach_neighbor()\n        if (val(Pc.x,0,0,0) && level == maxlevel) {\n          delta_h = delta_func(x1, y1, val(Pc.x,0,0,0), val(Pc.y,0,0,0), Delta);\n          \n            sum.x += val(Fd.x,0,0,0) * delta_h * (sq(Delta)*val(cm,0,0,0));\n            \n// #line 258\nsum.y += val(Fd.y,0,0,0) * delta_h * (sq(Delta)*val(cm,0,0,0));\n   delta_sum += delta_h;\n }end_foreach_neighbor()}\n    }\n     {\n     val_out_(fc.x,0,0,0) = val(vof,0,0,0) >= 0.499? (vc.x - val(u.x,0,0,0))/dt: correct.x * sum.x;\n\n\n\n    } \n// #line 262\n{\n     val_out_(fc.y,0,0,0) = val(vof,0,0,0) >= 0.499? (vc.y - val(u.y,0,0,0))/dt: correct.y * sum.y;\n\n\n\n    }\n    printx (point, 4);\n  }")}) {      
...
sum.y += val(Fd.y,0,0,0) * delta_h * (sq(Delta)*val(cm,0,0,0));
   delta_sum += delta_h;
     ...
     {
     val(fc.x,0,0,0) = val(vof,0,0,0) >= 0.499? (vc.x - val(u.x,0,0,0))/dt: correct.x * sum.x;
...
#line 262
{
     val(fc.y,0,0,0) = val(vof,0,0,0) >= 0.499? (vc.y - val(u.y,0,0,0))/dt: correct.y * sum.y;
...
#line 247
foreach_stencil(1,{(NonLocal[]){{"correct","coord",(void *)&correct,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"u","vector",(void *)&u,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"Fd","vector",(void *)&Fd,NULL,0},{"Pc","vector",(void *)&Pc,NULL,0},{"maxlevel","int",(void *)&maxlevel,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 106 \"./../immersed.h\"\nvoid printx (Point point, int j) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n// # 130 \"./../immersed.h\"\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}"),_(" \n// #line 247 \"./../immersed.h\"\n{\n    real delta_sum = 0.;\n    coord sum = {0};\n    if (level == maxlevel) {\n      real x1 = x;\n      real y1 = y;\n      real delta_h;\n      {foreach_neighbor()\n        if (val(Pc.x,0,0,0) && level == maxlevel) {\n          delta_h = delta_func(x1, y1, val(Pc.x,0,0,0), val(Pc.y,0,0,0), Delta);\n          \n            sum.x += val(Fd.x,0,0,0) * delta_h * (sq(Delta)*_const_cm);\n            \n// #line 258\nsum.y += val(Fd.y,0,0,0) * delta_h * (sq(Delta)*_const_cm);\n   delta_sum += delta_h;\n }end_foreach_neighbor()}\n    }\n     {\n     val_out_(fc.x,0,0,0) = val(vof,0,0,0) >= 0.499? (vc.x - val(u.x,0,0,0))/dt: correct.x * sum.x;\n\n\n\n    } \n// #line 262\n{\n     val_out_(fc.y,0,0,0) = val(vof,0,0,0) >= 0.499? (vc.y - val(u.y,0,0,0))/dt: correct.y * sum.y;\n\n\n\n    }\n    printx (point, 4);\n  }")}) {      
...
}{end_tracing("solid_force","./../immersed.h",0);return 0;}end_tracing("solid_force","./../immersed.h",0);}
...
#line 57
      static int moving_cylinder(const int i,const double t,Event *_ev){tracing("moving_cylinder","cylinder-oscv2.c",0); {
  xc.y = A*sin(2*M_PI*freq*t);
  vc.y = 2*M_PI*freq*A*cos(2*M_PI*freq*t);
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"xc","coord",(void *)&xc,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 60 \"cylinder-oscv2.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x - xc.x) - sq(y - ci.y - xc.y) + sq(0.50/2);")}) {_stencil_val_a(phi,0,0,0);               }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x - xc.x) - sq(y - ci.y - xc.y) + sq(0.50/2);end_foreach_vertex();} fractions (phi, vof, sf
#line 122 "/home/spencer/basilisk/src/fractions.h"
, 0.
#line 60 "cylinder-oscv2.c"
);delete((scalar*)((scalar[]){phi,{-1}})); } while(0);
}{end_tracing("moving_cylinder","cylinder-oscv2.c",0);return 0;}end_tracing("moving_cylinder","cylinder-oscv2.c",0);}
...
#line 64
      static int properties_0(const int i,const double t,Event *_ev){tracing("properties_0","cylinder-oscv2.c",0); {
  if(!is_constant(fm.x)){
  
#line 65
foreach_face_stencil(1,{(NonLocal[]){{"Re","int",(void *)&Re,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 65 \"cylinder-oscv2.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(0.50)/(Re);}end_is_face_x()\n// #line 65\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(0.50)/(Re);}end_is_face_y()}")}){_stencil_is_face_x(){
...
#line 65
foreach_face_generic(){is_face_x(){
    val(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(0.50)/(Re);}end_is_face_x()
#line 65
is_face_y(){
    val(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(0.50)/(Re);}end_is_face_y()}end_foreach_face_generic();}}else {_coord _const_fm={_constant[fm.x.i-_NVARMAX],_constant[fm.y.i-_NVARMAX]};NOT_UNUSED(_const_fm);
  
#line 65
foreach_face_stencil(1,{(NonLocal[]){{"Re","int",(void *)&Re,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 65 \"cylinder-oscv2.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(0.50)/(Re);}end_is_face_x()\n// #line 65\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(0.50)/(Re);}end_is_face_y()}")}){_stencil_is_face_x(){
...
#line 65
foreach_face_generic(){is_face_x(){
    val(muv.x,0,0,0) = _const_fm.x*(U0)*(0.50)/(Re);}end_is_face_x()
#line 65
is_face_y(){
    val(muv.y,0,0,0) = _const_fm.y*(U0)*(0.50)/(Re);}end_is_face_y()}end_foreach_face_generic();}}
   boundary_internal ((scalar *)(scalar *)((vector[]) {muv,{{-1},{-1}}}), "cylinder-oscv2.c", 0);
}{end_tracing("properties_0","cylinder-oscv2.c",0);return 0;}end_tracing("properties_0","cylinder-oscv2.c",0);}
...
#line 76
      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","cylinder-oscv2.c",0);{
  ...
  double CD = (Fp.x)/(0.5*sq(U0)*(0.50));
  avgCD += t > 20? CD: 0;
  double CL = (Fp.y)/(0.5*sq(U0)*(0.50));
  avgCL += t > 20? CL: 0;
  count += t > 20? 1:0;
...
#line 96
foreach_stencil(1,{(NonLocal[]){{"ub","vector",(void *)&ub,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"e","scalar",(void *)&e,NULL,0},{"usum","coord",(void *)&usum,NULL,0},{"Uc","vector",(void *)&Uc,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"u","vector",(void *)&u,NULL,0},{"counter","int",(void *)&counter,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 28 \"./../immersed.h\"\nvoid bilinear_interpolation (Point point, vector uv, coord pc, coord * uc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord uci;\n  real xc = pc.x;\n  real yc = pc.y;\n\n  real xx = x - xc;\n  real yy = y - yc;\n\n  real x2 = x - sign(xx)*Delta;\n  real y2 = y - sign(yy)*Delta;\n\n   {\n    uci.x = (x2 - xc)*(y2 - yc) * val(uv.x,0,0,0) +\n            (xc - x) * (y2 - yc) * val(uv.x,-sign(xx),0,0) +\n     (x2 - xc) * (yc - y) * val(uv.x,0,-sign(yy),0) +\n     (xc - x) * (yc - y) * val(uv.x,-sign(xx),-sign(yy),0);\n    uci.x /= ((x2 - x)*(y2 - y));\n  } \n// #line 39\n{\n    uci.y = (x2 - xc)*(y2 - yc) * val(uv.y,0,0,0) +\n            (xc - x) * (y2 - yc) * val(uv.y,0,-sign(xx),0) +\n     (x2 - xc) * (yc - y) * val(uv.y,-sign(yy),0,0) +\n     (xc - x) * (yc - y) * val(uv.y,-sign(yy),-sign(xx),0);\n    uci.y /= ((x2 - x)*(y2 - y));\n  }\n\n  *uc = uci;\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 2 \"cylinder-oscv2.c\" 2\n// # 1 \"../immersed.h\" 1\n// # 1 \"./../immersed.h\"\n// # 1 \"./fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"./geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"./myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}"),_(" \n// #line 96 \"cylinder-oscv2.c\"\n{\n    if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1) {\n      counter++;\n      coord pc, uc, ucb;\n      coord m = {x, y};\n      coord n = mycs (point, vof);\n      real alpha = line_alpha (val(vof,0,0,0), n);\n      real area = line_length_center(n,alpha,&pc);\n\n      \n        pc.x = m.x + pc.x*Delta;\n        \n// #line 106\npc.y = m.y + pc.y*Delta;\n\n      coord sum = {0};\n        {foreach_neighbor() {\n          real delta_u = delta_func (x, y, pc.x, pc.y, Delta);\n          \n     sum.x += val(u.x,0,0,0)*delta_u*(sq(Delta)*val(cm,0,0,0));\n     \n// #line 112\nsum.y += val(u.y,0,0,0)*delta_u*(sq(Delta)*val(cm,0,0,0));\n        }end_foreach_neighbor()}\n      bilinear_interpolation (point, u, pc, &ucb);\n\n       {\n        uc.x = sum.x;\n val_out_(Uc.x,0,0,0) = ucb.x;\n usum.x += ucb.x;\n      } \n// #line 116\n{\n        uc.y = sum.y;\n val_out_(Uc.y,0,0,0) = ucb.y;\n usum.y += ucb.y;\n      }\n      val_out_(e,0,0,0) = fabs(val(u.y,0,0,0) - vc.y) / vc.y;\n    }\n    else\n      { {\n        val_out_(Uc.x,0,0,0) = 0;\n        val_out_(ub.x,0,0,0) = 0;\n      } \n// #line 124\n{\n        val_out_(Uc.y,0,0,0) = 0;\n        val_out_(ub.y,0,0,0) = 0;\n      }}\n  }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ {         
...
{ _stencil_val(u.y,0,0,0);_stencil_val(cm,0,0,0); }
 ...
 _stencil_val_a(Uc.x,0,0,0);   
  
      } 
#line 116
{ 
         
 _stencil_val_a(Uc.y,0,0,0);   
...
{
        _stencil_val_a(Uc.x,0,0,0);  
        _stencil_val_a(ub.x,0,0,0);  
      } 
#line 124
{
        _stencil_val_a(Uc.y,0,0,0);  
        _stencil_val_a(ub.y,0,0,0);  
      }}
...
sum.y += val(u.y,0,0,0)*delta_u*(sq(Delta)*val(cm,0,0,0));
      ...
      bilinear_interpolation (point, u, pc, &ucb);
       ...
       {
        uc.x = sum.x;
 val(Uc.x,0,0,0) = ucb.x;
 usum.x += ucb.x;
      } 
#line 116
{
        uc.y = sum.y;
 val(Uc.y,0,0,0) = ucb.y;
 usum.y += ucb.y;
      }
      val(e,0,0,0) = fabs(val(u.y,0,0,0) - vc.y) / vc.y;
    }
    else
      { {
        val(Uc.x,0,0,0) = 0;
...
#line 96
foreach_stencil(1,{(NonLocal[]){{"ub","vector",(void *)&ub,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"e","scalar",(void *)&e,NULL,0},{"usum","coord",(void *)&usum,NULL,0},{"Uc","vector",(void *)&Uc,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"u","vector",(void *)&u,NULL,0},{"counter","int",(void *)&counter,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 28 \"./../immersed.h\"\nvoid bilinear_interpolation (Point point, vector uv, coord pc, coord * uc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord uci;\n  real xc = pc.x;\n  real yc = pc.y;\n\n  real xx = x - xc;\n  real yy = y - yc;\n\n  real x2 = x - sign(xx)*Delta;\n  real y2 = y - sign(yy)*Delta;\n\n   {\n    uci.x = (x2 - xc)*(y2 - yc) * val(uv.x,0,0,0) +\n            (xc - x) * (y2 - yc) * val(uv.x,-sign(xx),0,0) +\n     (x2 - xc) * (yc - y) * val(uv.x,0,-sign(yy),0) +\n     (xc - x) * (yc - y) * val(uv.x,-sign(xx),-sign(yy),0);\n    uci.x /= ((x2 - x)*(y2 - y));\n  } \n// #line 39\n{\n    uci.y = (x2 - xc)*(y2 - yc) * val(uv.y,0,0,0) +\n            (xc - x) * (y2 - yc) * val(uv.y,0,-sign(xx),0) +\n     (x2 - xc) * (yc - y) * val(uv.y,-sign(yy),0,0) +\n     (xc - x) * (yc - y) * val(uv.y,-sign(yy),-sign(xx),0);\n    uci.y /= ((x2 - x)*(y2 - y));\n  }\n\n  *uc = uci;\n}\n\n\n// #line 70 \"./../immersed.h\"\nreal phi_func (real x, real h) {\n  real r = x / h;\n  real phi;\n  if (fabs(r) <= 1)\n    phi = (1./8.) * (3 - (2 * fabs(r)) + sqrt (1 + (4 * fabs(r)) - (4 * sq(r))));\n  else if (fabs(r) > 1 && fabs(r) <= 2)\n    phi = (1./8.) * (5 - (2 * fabs(r)) - sqrt (-7 + (12 * fabs(r)) - ( 4 * sq(r))));\n  else\n    phi = 0;\n  return phi;\n}\n\n\n// #line 82 \"./../immersed.h\"\nreal delta_func (real x, real y, real xc, real yc, real Delta) {\n  real phi_x = phi_func (x - xc, Delta);\n  real phi_y = phi_func (y - yc, Delta);\n  return (phi_x * phi_y) / sq(Delta);\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 2 \"cylinder-oscv2.c\" 2\n// # 1 \"../immersed.h\" 1\n// # 1 \"./../immersed.h\"\n// # 1 \"./fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"./geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"./myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}"),_(" \n// #line 96 \"cylinder-oscv2.c\"\n{\n    if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1) {\n      counter++;\n      coord pc, uc, ucb;\n      coord m = {x, y};\n      coord n = mycs (point, vof);\n      real alpha = line_alpha (val(vof,0,0,0), n);\n      real area = line_length_center(n,alpha,&pc);\n\n      \n        pc.x = m.x + pc.x*Delta;\n        \n// #line 106\npc.y = m.y + pc.y*Delta;\n\n      coord sum = {0};\n        {foreach_neighbor() {\n          real delta_u = delta_func (x, y, pc.x, pc.y, Delta);\n          \n     sum.x += val(u.x,0,0,0)*delta_u*(sq(Delta)*_const_cm);\n     \n// #line 112\nsum.y += val(u.y,0,0,0)*delta_u*(sq(Delta)*_const_cm);\n        }end_foreach_neighbor()}\n      bilinear_interpolation (point, u, pc, &ucb);\n\n       {\n        uc.x = sum.x;\n val_out_(Uc.x,0,0,0) = ucb.x;\n usum.x += ucb.x;\n      } \n// #line 116\n{\n        uc.y = sum.y;\n val_out_(Uc.y,0,0,0) = ucb.y;\n usum.y += ucb.y;\n      }\n      val_out_(e,0,0,0) = fabs(val(u.y,0,0,0) - vc.y) / vc.y;\n    }\n    else\n      { {\n        val_out_(Uc.x,0,0,0) = 0;\n        val_out_(ub.x,0,0,0) = 0;\n      } \n// #line 124\n{\n        val_out_(Uc.y,0,0,0) = 0;\n        val_out_(ub.y,0,0,0) = 0;\n      }}\n  }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0);{ {         
...
#line 124
{
  ...
  fprintf (ferr, "%d %g %d %d %d %d %d %g %g %g %g %g %g %g %g %g %g\n",
    i, t, Re, mgp.i, mgp.nrelax, mgu.i, mgu.nrelax,
    CD, avgCD/(count + 1e-6), CL, avgCL/(count + 1e-6),
    uavg_x, uavg_y, xc.y, vc.y, n.avg, n.max);
}{end_tracing("logfile","cylinder-oscv2.c",0);return 0;}end_tracing("logfile","cylinder-oscv2.c",0);}

static int profile_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = t_end)!=0;*ip=i;*tp=t;return ret;}


#line 140
      static int profile(const int i,const double t,Event *_ev){tracing("profile","cylinder-oscv2.c",0); {
  double delta = 20/(pow(2,12));
  char name[80];

  sprintf (name, "surface-%d", Re);
  FILE * fv5 = fopen (name, "w");
  foreach_stencil(1,{(NonLocal[]){{"fv5","not implemented yet",(void *)fv5,NULL,1},{"U0","double",(void *)&U0,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"p","scalar",(void *)&p,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"u","vector",(void *)&u,NULL,0},{"vof","scalar",(void *)&vof,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n\n\n// #line 50 \"./../immersed.h\"\nreal scalar_bilinear_interpolation (Point point, scalar p, coord pc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  real pci;\n  real xc = pc.x;\n  real yc = pc.y;\n\n  real xx = x - xc;\n  real yy = y - yc;\n\n  real x2 = x - sign(xx)*Delta;\n  real y2 = y - sign(yy)*Delta;\n\n  pci = (x2 - xc)*(y2 - yc) * val(p,0,0,0) +\n            (xc - x) * (y2 - yc) * val(p,-sign(xx),0,0) +\n     (x2 - xc) * (yc - y) * val(p,0,-sign(yy),0) +\n     (xc - x) * (yc - y) * val(p,-sign(xx),-sign(yy),0);\n  pci /= ((x2 - x)*(y2 - y));\n\n  return pci;\n}\n\n\n// #line 28 \"./../immersed.h\"\nvoid bilinear_interpolation (Point point, vector uv, coord pc, coord * uc) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  coord uci;\n  real xc = pc.x;\n  real yc = pc.y;\n\n  real xx = x - xc;\n  real yy = y - yc;\n\n  real x2 = x - sign(xx)*Delta;\n  real y2 = y - sign(yy)*Delta;\n\n   {\n    uci.x = (x2 - xc)*(y2 - yc) * val(uv.x,0,0,0) +\n            (xc - x) * (y2 - yc) * val(uv.x,-sign(xx),0,0) +\n     (x2 - xc) * (yc - y) * val(uv.x,0,-sign(yy),0) +\n     (xc - x) * (yc - y) * val(uv.x,-sign(xx),-sign(yy),0);\n    uci.x /= ((x2 - x)*(y2 - y));\n  } \n// #line 39\n{\n    uci.y = (x2 - xc)*(y2 - yc) * val(uv.y,0,0,0) +\n            (xc - x) * (y2 - yc) * val(uv.y,0,-sign(xx),0) +\n     (x2 - xc) * (yc - y) * val(uv.y,-sign(yy),0,0) +\n     (xc - x) * (yc - y) * val(uv.y,-sign(yy),-sign(xx),0);\n    uci.y /= ((x2 - x)*(y2 - y));\n  }\n\n  *uc = uci;\n}\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 2 \"cylinder-oscv2.c\" 2\n// # 1 \"../immersed.h\" 1\n// # 1 \"./../immersed.h\"\n// # 1 \"./fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"./geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"./myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}"),_(" \n// #line 146 \"cylinder-oscv2.c\"\n{\n    if (val(vof,0,0,0) > 0 && val(vof,0,0,0) < 1) {\n      coord pc, ucb, fcb;\n      coord m = {x, y};\n      coord n = mycs (point, vof);\n      real alpha = line_alpha (val(vof,0,0,0), n);\n      real area = line_length_center(n,alpha,&pc);\n\n      \n        pc.x = m.x + pc.x*Delta;\n        \n// #line 155\npc.y = m.y + pc.y*Delta;\n\n      bilinear_interpolation (point, u, pc, &ucb);\n      bilinear_interpolation (point, fc, pc, &fcb);\n      real pcb = scalar_bilinear_interpolation (point, p, pc);\n\n\n      real theta = atan2 ((y - ci.y), (x - ci.x)) * (180/M_PI) + 180;\n      real umag = sqrt(sq(ucb.x) + sq(ucb.y));\n      real fmag = sqrt(sq(fcb.x) + sq(fcb.y));\n      real cp = pcb / (0.5 * sq(U0));\n      fprintf (fv5, \"%g %g %g %g\\n\", fabs(theta), umag, fmag, cp);\n    }\n  }")}) {
_stencil_val(vof,0,0,0); _stencil_val(vof,0,0,0); {         
      ...
      _stencil_bilinear_interpolation (point, u,NULL ,NULL );
      _stencil_bilinear_interpolation (point, fc,NULL ,NULL );  
...
}{end_tracing("profile","cylinder-oscv2.c",0);return 0;}end_tracing("profile","cylinder-oscv2.c",0);}

scalar  omega={30};

static int movie_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.1)!=0;*ip=i;*tp=t;return ret;}


#line 176
      static int movie(const int i,const double t,Event *_ev){tracing("movie","cylinder-oscv2.c",0); {
  vorticity (u, omega);
  char name[80];
  sprintf (name, "vort-%d-%g", Re, t)
  view (fov = 3, tx = -(40./ci.x), ty = -(40./ci.y), bg = {1,1,1,})
  isoline ("omega");
  draw_vof ("vof", "sf"
#line 886 "/home/spencer/basilisk/src/draw.h"
, false, 
0.
#line 182 "cylinder-oscv2.c"
, 1
...
NULL
#line 184 "cylinder-oscv2.c"
);
}{end_tracing("movie","cylinder-oscv2.c",0);return 0;}end_tracing("movie","cylinder-oscv2.c",0);}
...
#line 188
      static int snapshot(const int i,const double t,Event *_ev){tracing("snapshot","cylinder-oscv2.c",0); {
  vorticity (u, omega);

  char name[80];
  sprintf (name, "vort-%d.png", Re);
  view ( -(40./ci.x), -(40./ci.y), 2
...
NULL
#line 197 "cylinder-oscv2.c"
);
}{end_tracing("snapshot","cylinder-oscv2.c",0);return 0;}end_tracing("snapshot","cylinder-oscv2.c",0);}
...
#line 201
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","cylinder-oscv2.c",0); {
  vorticity (u, omega);
  adapt_wavelet (
#line 203 "/home/spencer/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 203
)
#line 203 "cylinder-oscv2.c"
((scalar[]){vof,u.x,u.y,{-1}}), (double[]){1.e-2,3e-3,3e-3}
, 12, 2
#line 176 "/home/spencer/basilisk/src/grid/tree-common.h"
, 
all
#line 204 "cylinder-oscv2.c"
);
}{end_tracing("adapt_0","cylinder-oscv2.c",0);return 0;}end_tracing("adapt_0","cylinder-oscv2.c",0);}
...
#line 208
      static int stop(const int i,const double t,Event *_ev){tracing("stop","cylinder-oscv2.c",0); {
  static FILE * fp =NULL;if(!fp||i==0)fp=pid()>0?fopen("/dev/null","w"): fopen("perf", "w");
  timing s = timer_timing (perf.gt, iter, perf.tnc, NULL);
  fprintf (fp, "%d\t%g\t%d\t%g\n", Re, s.real, i, s.speed);
  fflush (fp);
  {end_tracing("stop","cylinder-oscv2.c",0);return 1;}
}{end_tracing("stop","cylinder-oscv2.c",0);return 0;}end_tracing("stop","cylinder-oscv2.c",0);}
# 2 "ast/init_solver.h"

static void _init_solver (void)
{
  void init_solver();
datasize=31*sizeof(double);
...
#line 133 "./../immersed.h"
event_register((Event){0,1,solid_force,{solid_force_expr0},((int *)0),((double *)0),"./../immersed.h",0,"solid_force"});  
#line 57 "cylinder-oscv2.c"
event_register((Event){0,1,moving_cylinder,{moving_cylinder_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"moving_cylinder"});  
#line 76
event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"logfile"});  
#line 140
event_register((Event){0,1,profile,{profile_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"profile"});  
#line 176
event_register((Event){0,1,movie,{movie_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"movie"});  
#line 188
event_register((Event){0,1,snapshot,{snapshot_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"snapshot"});  
#line 208
event_register((Event){0,1,stop,{stop_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"stop"});
...
#line 64 "cylinder-oscv2.c"
event_register((Event){0,1,properties_0,{properties_0_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"properties"});  
#line 201
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"cylinder-oscv2.c",0,"adapt"});

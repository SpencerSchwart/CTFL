#line 0 "cylinderO-cpp.c"
#line 0 "<built-in>"
#line 0 "<command-line>"
#line 1 "/usr/include/stdc-predef.h"
#line 0 "<command-line>"
#line 1 "cylinderO-cpp.c"
#if 700 < 700
  #undef 700
  #define 700 700
#endif
...
#line 15 "cylinderO-cpp.c"
#line 1 "cylinderO.c"
#line 1 "axi.h"
#line 1 "/home/spencer/basilisk/src/axi.h"
#line 20 "/home/spencer/basilisk/src/axi.h"
static void refine_cm_axi (Point point, scalar cm)
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;

  fine(cm,0,0,0) = fine(cm,1,0,0) = y - Delta/4.;
  fine(cm,0,1,0) = fine(cm,1,1,0) = y + Delta/4.;
#line 45 "/home/spencer/basilisk/src/axi.h"
}
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  ...
  if (!(!is_leaf (neighbor(-1,0,0)) && neighbor(-1,0,0).neighbors && neighbor(-1,0,0).pid >= 0)) {
    fine(fm,0,0,0) = y - Delta/4.;
    fine(fm,0,1,0) = y + Delta/4.;
  }
  if (!(!is_leaf (neighbor(1,0,0)) && neighbor(1,0,0).neighbors && neighbor(1,0,0).pid >= 0) && neighbor(1,0,0).neighbors) {
    fine(fm,2,0,0) = y - Delta/4.;
    fine(fm,2,1,0) = y + Delta/4.;
  }
  fine(fm,1,0,0) = y - Delta/4.;
  fine(fm,1,1,0) = y + Delta/4.;
#line 83 "/home/spencer/basilisk/src/axi.h"
}
...
#line 151 "/home/spencer/basilisk/src/axi.h"
      static int metric(const int i,const double t,Event *_ev){tracing("metric","/home/spencer/basilisk/src/axi.h",0); {
...
#line 180 "/home/spencer/basilisk/src/axi.h"
  scalar cmv = cm;
  foreach_stencil(1,{(NonLocal[]){{"cmv","scalar",(void *)&cmv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 182 \"/home/spencer/basilisk/src/axi.h\"\nval_out_(cmv,0,0,0) = y;"})
...
_attribute[cm.i].dirty=1,_attribute[cm.i].boundary[bottom]=_boundary1,_attribute[cm.i].boundary_homogeneous[bottom]=_boundary1_homogeneous;
  ...
  vector fmv = fm;
  foreach_face_stencil(1,{(NonLocal[]){{"fmv","vector",(void *)&fmv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 200 \"/home/spencer/basilisk/src/axi.h\"\n{is_face_x(){\n    val_out_(fmv.x,0,0,0) = max(y, 1./1e30);}end_is_face_x()\n// #line 200\nis_face_y(){\n    val_out_(fmv.y,0,0,0) = max(y, 1./1e30);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 200
foreach_face_generic(){is_face_x(){
    val(fmv.x,0,0,0) = max(y, 1./1e30);}end_is_face_x()
#line 200
is_face_y(){
    val(fmv.y,0,0,0) = max(y, 1./1e30);}end_is_face_y()}end_foreach_face_generic();}
...
}{end_tracing("metric","/home/spencer/basilisk/src/axi.h",0);return 0;}end_tracing("metric","/home/spencer/basilisk/src/axi.h",0);}
#line 2 "cylinderO.c"
...
#line 434 "/home/spencer/basilisk/src/utils.h"
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/val(rho,0,0,0)*(val(mu.x,0,0,0) + val(mu.x,1,0,0) + val(mu.y,0,0,0) + val(mu.y,0,1,0))/2./sq(y)}).x + dt/val(rho,0,0,0)*(2.*val(mu.x,1,0,0) + 2.*val(mu.x,0,0,0)
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/val(rho,0,0,0)*(val(mu.y,0,0,0) + val(mu.y,0,1,0) + val(mu.x,0,0,0) + val(mu.x,1,0,0))/2./sq(y)}).y + dt/val(rho,0,0,0)*(2.*val(mu.y,0,1,0) + 2.*val(mu.y,0,0,0)
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/_const_rho*(val(mu.x,0,0,0) + val(mu.x,1,0,0) + val(mu.y,0,0,0) + val(mu.y,0,1,0))/2./sq(y)}).x + dt/_const_rho*(2.*val(mu.x,1,0,0) + 2.*val(mu.x,0,0,0)
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/_const_rho*(val(mu.y,0,0,0) + val(mu.y,0,1,0) + val(mu.x,0,0,0) + val(mu.x,1,0,0))/2./sq(y)}).y + dt/_const_rho*(2.*val(mu.y,0,1,0) + 2.*val(mu.y,0,0,0)
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/val(rho,0,0,0)*(_const_mu.x + _const_mu.x + _const_mu.y + _const_mu.y)/2./sq(y)}).x + dt/val(rho,0,0,0)*(2.*_const_mu.x + 2.*_const_mu.x
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/val(rho,0,0,0)*(_const_mu.y + _const_mu.y + _const_mu.x + _const_mu.x)/2./sq(y)}).y + dt/val(rho,0,0,0)*(2.*_const_mu.y + 2.*_const_mu.y
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/_const_rho*(_const_mu.x + _const_mu.x + _const_mu.y + _const_mu.y)/2./sq(y)}).x + dt/_const_rho*(2.*_const_mu.x + 2.*_const_mu.x
...
#line 168 "/home/spencer/basilisk/src/viscosity.h"
    ...
    (sq(Delta)*((coord){1., 1. + dt/_const_rho*(_const_mu.y + _const_mu.y + _const_mu.x + _const_mu.x)/2./sq(y)}).y + dt/_const_rho*(2.*_const_mu.y + 2.*_const_mu.y
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"mu","vector",(void *)&mu,NULL,0},{"rho","scalar",(void *)&rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n \n// #line 242\nd += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n      val_out_(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(val(mu.x,0,0,0) + val(mu.x,1,0,0) + val(mu.y,0,0,0) + val(mu.y,0,1,0))/2./sq(y)}).x*val(u.x,0,0,0) + dt/val(rho,0,0,0)*d/Delta;\n      if (fabs (val(res.x,0,0,0)) > maxres)\n maxres = fabs (val(res.x,0,0,0));\n    }"}) {   
...
_stencil_val(r.x,0,0,0);_stencil_val(rho,0,0,0);_stencil_val(mu.x,0,0,0); _stencil_val(mu.x,1,0,0); _stencil_val(mu.y,0,0,0); _stencil_val(mu.y,0,1,0);_stencil_val(u.x,0,0,0);_stencil_val(rho,0,0,0);
...
#line 242
d += val(taux.y,0,1,0) - val(taux.y,0,0,0);
      val(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(val(mu.x,0,0,0) + val(mu.x,1,0,0) + val(mu.y,0,0,0) + val(mu.y,0,1,0))/2./sq(y)}).x*val(u.x,0,0,0) + dt/val(rho,0,0,0)*d/Delta;
      if (fabs (val(res.x,0,0,0)) > maxres)
 maxres = fabs (val(res.x,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"mu","vector",(void *)&mu,NULL,0},{"_const_rho","double",(void *)&_const_rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n \n// #line 242\nd += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n      val_out_(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/_const_rho*(val(mu.x,0,0,0) + val(mu.x,1,0,0) + val(mu.y,0,0,0) + val(mu.y,0,1,0))/2./sq(y)}).x*val(u.x,0,0,0) + dt/_const_rho*d/Delta;\n      if (fabs (val(res.x,0,0,0)) > maxres)\n maxres = fabs (val(res.x,0,0,0));\n    }"}) {   
...
#line 242
{ _stencil_val(taux.y,0,1,0); _stencil_val(taux.y,0,0,0);  } 
_stencil_val(r.x,0,0,0);;_stencil_val(mu.x,0,0,0); _stencil_val(mu.x,1,0,0); _stencil_val(mu.y,0,0,0); _stencil_val(mu.y,0,1,0);_stencil_val(u.x,0,0,0);;
...
#line 242
d += val(taux.y,0,1,0) - val(taux.y,0,0,0);
      val(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/_const_rho*(val(mu.x,0,0,0) + val(mu.x,1,0,0) + val(mu.y,0,0,0) + val(mu.y,0,1,0))/2./sq(y)}).x*val(u.x,0,0,0) + dt/_const_rho*d/Delta;
      if (fabs (val(res.x,0,0,0)) > maxres)
 maxres = fabs (val(res.x,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 246
}else if(!is_constant(rho) && is_constant(mu.x)){_coord _const_mu={_constant[mu.x.i-_NVARMAX],_constant[mu.y.i-_NVARMAX]};NOT_UNUSED(_const_mu);
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"_const_mu","_coord",(void *)&_const_mu,NULL,0},{"rho","scalar",(void *)&rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n \n// #line 242\nd += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n      val_out_(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(_const_mu.x + _const_mu.x + _const_mu.y + _const_mu.y)/2./sq(y)}).x*val(u.x,0,0,0) + dt/val(rho,0,0,0)*d/Delta;\n      if (fabs (val(res.x,0,0,0)) > maxres)\n maxres = fabs (val(res.x,0,0,0));\n    }"}) {   
...
#line 242
{ _stencil_val(taux.y,0,1,0); _stencil_val(taux.y,0,0,0);  } 
_stencil_val(r.x,0,0,0);_stencil_val(rho,0,0,0);;;;;_stencil_val(u.x,0,0,0);_stencil_val(rho,0,0,0);
...
#line 242
d += val(taux.y,0,1,0) - val(taux.y,0,0,0);
      val(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(_const_mu.x + _const_mu.x + _const_mu.y + _const_mu.y)/2./sq(y)}).x*val(u.x,0,0,0) + dt/val(rho,0,0,0)*d/Delta;
      if (fabs (val(res.x,0,0,0)) > maxres)
 maxres = fabs (val(res.x,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 246
}else {double _const_rho=_constant[rho.i-_NVARMAX];NOT_UNUSED(_const_rho);_coord _const_mu={_constant[mu.x.i-_NVARMAX],_constant[mu.y.i-_NVARMAX]};NOT_UNUSED(_const_mu);
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"_const_mu","_coord",(void *)&_const_mu,NULL,0},{"_const_rho","double",(void *)&_const_rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n \n// #line 242\nd += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n      val_out_(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/_const_rho*(_const_mu.x + _const_mu.x + _const_mu.y + _const_mu.y)/2./sq(y)}).x*val(u.x,0,0,0) + dt/_const_rho*d/Delta;\n      if (fabs (val(res.x,0,0,0)) > maxres)\n maxres = fabs (val(res.x,0,0,0));\n    }"}) {   
...
#line 242
d += val(taux.y,0,1,0) - val(taux.y,0,0,0);
      val(res.x,0,0,0) = val(r.x,0,0,0) - ((coord){1., 1. + dt/_const_rho*(_const_mu.x + _const_mu.x + _const_mu.y + _const_mu.y)/2./sq(y)}).x*val(u.x,0,0,0) + dt/_const_rho*d/Delta;
      if (fabs (val(res.x,0,0,0)) > maxres)
 maxres = fabs (val(res.x,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
foreach_face_generic()is_face_x(){
 val(taux.x,0,0,0) = _const_mu.x*(val(u.y,0,0,0) - val(u.y,-1,0,0) +
    ...
    if(!is_constant(rho) && !is_constant(mu.y)){
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"mu","vector",(void *)&mu,NULL,0},{"rho","scalar",(void *)&rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n \n// #line 242\nd += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n      val_out_(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(val(mu.y,0,0,0) + val(mu.y,0,1,0) + val(mu.x,0,0,0) + val(mu.x,1,0,0))/2./sq(y)}).y*val(u.y,0,0,0) + dt/val(rho,0,0,0)*d/Delta;\n      if (fabs (val(res.y,0,0,0)) > maxres)\n maxres = fabs (val(res.y,0,0,0));\n    }"}) {   
...
#line 242
{ _stencil_val(taux.x,1,0,0); _stencil_val(taux.x,0,0,0);  } 
_stencil_val(r.y,0,0,0);_stencil_val(rho,0,0,0);_stencil_val(mu.y,0,0,0); _stencil_val(mu.y,0,1,0); _stencil_val(mu.x,0,0,0); _stencil_val(mu.x,1,0,0);_stencil_val(u.y,0,0,0);_stencil_val(rho,0,0,0);
...
#line 242
d += val(taux.x,1,0,0) - val(taux.x,0,0,0);
      val(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(val(mu.y,0,0,0) + val(mu.y,0,1,0) + val(mu.x,0,0,0) + val(mu.x,1,0,0))/2./sq(y)}).y*val(u.y,0,0,0) + dt/val(rho,0,0,0)*d/Delta;
      if (fabs (val(res.y,0,0,0)) > maxres)
 maxres = fabs (val(res.y,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 246
}else if(is_constant(rho) && !is_constant(mu.y)){double _const_rho=_constant[rho.i-_NVARMAX];NOT_UNUSED(_const_rho);
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"mu","vector",(void *)&mu,NULL,0},{"_const_rho","double",(void *)&_const_rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n \n// #line 242\nd += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n      val_out_(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/_const_rho*(val(mu.y,0,0,0) + val(mu.y,0,1,0) + val(mu.x,0,0,0) + val(mu.x,1,0,0))/2./sq(y)}).y*val(u.y,0,0,0) + dt/_const_rho*d/Delta;\n      if (fabs (val(res.y,0,0,0)) > maxres)\n maxres = fabs (val(res.y,0,0,0));\n    }"}) {   
...
#line 242
{ _stencil_val(taux.x,1,0,0); _stencil_val(taux.x,0,0,0);  } 
_stencil_val(r.y,0,0,0);;_stencil_val(mu.y,0,0,0); _stencil_val(mu.y,0,1,0); _stencil_val(mu.x,0,0,0); _stencil_val(mu.x,1,0,0);_stencil_val(u.y,0,0,0);;
...
#line 242
d += val(taux.x,1,0,0) - val(taux.x,0,0,0);
      val(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/_const_rho*(val(mu.y,0,0,0) + val(mu.y,0,1,0) + val(mu.x,0,0,0) + val(mu.x,1,0,0))/2./sq(y)}).y*val(u.y,0,0,0) + dt/_const_rho*d/Delta;
      if (fabs (val(res.y,0,0,0)) > maxres)
 maxres = fabs (val(res.y,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 246
}else if(!is_constant(rho) && is_constant(mu.y)){_coord _const_mu={_constant[mu.y.i-_NVARMAX],_constant[mu.x.i-_NVARMAX]};NOT_UNUSED(_const_mu);
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"_const_mu","_coord",(void *)&_const_mu,NULL,0},{"rho","scalar",(void *)&rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n \n// #line 242\nd += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n      val_out_(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(_const_mu.y + _const_mu.y + _const_mu.x + _const_mu.x)/2./sq(y)}).y*val(u.y,0,0,0) + dt/val(rho,0,0,0)*d/Delta;\n      if (fabs (val(res.y,0,0,0)) > maxres)\n maxres = fabs (val(res.y,0,0,0));\n    }"}) {   
...
#line 242
{ _stencil_val(taux.x,1,0,0); _stencil_val(taux.x,0,0,0);  } 
_stencil_val(r.y,0,0,0);_stencil_val(rho,0,0,0);;;;;_stencil_val(u.y,0,0,0);_stencil_val(rho,0,0,0);
...
#line 242
d += val(taux.x,1,0,0) - val(taux.x,0,0,0);
      val(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/val(rho,0,0,0)*(_const_mu.y + _const_mu.y + _const_mu.x + _const_mu.x)/2./sq(y)}).y*val(u.y,0,0,0) + dt/val(rho,0,0,0)*d/Delta;
      if (fabs (val(res.y,0,0,0)) > maxres)
 maxres = fabs (val(res.y,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 246
}else {double _const_rho=_constant[rho.i-_NVARMAX];NOT_UNUSED(_const_rho);_coord _const_mu={_constant[mu.y.i-_NVARMAX],_constant[mu.x.i-_NVARMAX]};NOT_UNUSED(_const_mu);
...
#line 239
foreach_stencil (1,{(NonLocal[]){{"maxres","double",(void *)&maxres,NULL,0,'M'},{"u","vector",(void *)&u,NULL,0},{"_const_mu","_coord",(void *)&_const_mu,NULL,0},{"_const_rho","double",(void *)&_const_rho,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"r","vector",(void *)&r,NULL,0},{"res","vector",(void *)&res,NULL,0},{"taux","vector",(void *)&taux,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 239 \"/home/spencer/basilisk/src/viscosity.h\"\n{\n      real d = 0.;\n      \n d += val(taux.y,0,1,0) - val(taux.y,0,0,0);\n \n// #line 242\nd += val(taux.x,1,0,0) - val(taux.x,0,0,0);\n      val_out_(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/_const_rho*(_const_mu.y + _const_mu.y + _const_mu.x + _const_mu.x)/2./sq(y)}).y*val(u.y,0,0,0) + dt/_const_rho*d/Delta;\n      if (fabs (val(res.y,0,0,0)) > maxres)\n maxres = fabs (val(res.y,0,0,0));\n    }"}) {   
...
#line 242
d += val(taux.x,1,0,0) - val(taux.x,0,0,0);
      val(res.y,0,0,0) = val(r.y,0,0,0) - ((coord){1., 1. + dt/_const_rho*(_const_mu.y + _const_mu.y + _const_mu.x + _const_mu.x)/2./sq(y)}).y*val(u.y,0,0,0) + dt/_const_rho*d/Delta;
      if (fabs (val(res.y,0,0,0)) > maxres)
 maxres = fabs (val(res.y,0,0,0));
    }end_foreach();mpi_all_reduce_array(&maxres,double,MPI_MAX,1);
#undef OMP_PARALLEL
...
#line 14
{
  ...
  correction(-dt);
  foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 19 \"./../immersed.h\"\n{\n      val_out_(g.x,0,0,0) += val(aF.x,0,0,0);\n      \n// #line 20\nval_out_(g.y,0,0,0) += val(aF.y,0,0,0);}"})
    {
...
#line 33 "./../immersed.h"
void normal_vector (Point point, vector fc, coord * nv) {int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
  coord n;
   {
...
void interface_area_field (scalar c, scalar a) {
  foreach_stencil(1,{(NonLocal[]){{"a","scalar",(void *)&a,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 415 \"/home/spencer/basilisk/src/view.h\" 2\n\n\n\n\n\n\n// # 1 \"./draw.h\" 1\n// # 1 \"/home/spencer/basilisk/src/draw.h\"\n\n\n\n\n// # 1 \"./fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"./geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"./myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}"," \n// #line 58 \"./../immersed.h\"\n{\n    if (val(c,0,0,0) > 0 && val(c,0,0,0) < 1) {\n      coord n = mycs (point, c), p;\n      real alpha = line_alpha (val(c,0,0,0), n);\n      val_out_(a,0,0,0) = pow(Delta, 2 - 1)*line_length_center(n,alpha,&p);\n    }\n  }"}) {
_stencil_val(c,0,0,0); _stencil_val(c,0,0,0); {   
       _stencil_mycs (point, c);     
      _stencil_val(c,0,0,0);
...
foreach() {
    if (val(c,0,0,0) > 0 && val(c,0,0,0) < 1) {
      coord n = mycs (point, c), p;
      double alpha = line_alpha (val(c,0,0,0), n);
      val(a,0,0,0) = pow(Delta, 2 - 1)*line_length_center(n,alpha,&p);
    }
  }end_foreach();}
}
...
#line 69
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 69 \"./../immersed.h\"\n{\n    real area = val(c,0,0,0)*(sq(Delta)*val(cm,0,0,0));\n    \n      Fi.x += - val(fm.x,0,0,0)*(val(aF.x,0,0,0))*area;\n      \n// #line 72\nFi.y += - val(fm.y,0,0,0)*(val(aF.y,0,0,0))*area;\n   }"}) {  
...
#line 69
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 69 \"./../immersed.h\"\n{\n    real area = val(c,0,0,0)*(sq(Delta)*_const_cm);\n    \n      Fi.x += - val(fm.x,0,0,0)*(val(aF.x,0,0,0))*area;\n      \n// #line 72\nFi.y += - val(fm.y,0,0,0)*(val(aF.y,0,0,0))*area;\n   }"}) {
; _stencil_val(c,0,0,0);
...
#line 69
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"cm","scalar",(void *)&cm,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 69 \"./../immersed.h\"\n{\n    real area = val(c,0,0,0)*(sq(Delta)*val(cm,0,0,0));\n    \n      Fi.x += - _const_fm.x*(val(aF.x,0,0,0))*area;\n      \n// #line 72\nFi.y += - _const_fm.y*(val(aF.y,0,0,0))*area;\n   }"}) {  
    _stencil_val(cm,0,0,0); _stencil_val(c,0,0,0);
...
#line 69
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"_const_cm","double",(void *)&_const_cm,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 69 \"./../immersed.h\"\n{\n    real area = val(c,0,0,0)*(sq(Delta)*_const_cm);\n    \n      Fi.x += - _const_fm.x*(val(aF.x,0,0,0))*area;\n      \n// #line 72\nFi.y += - _const_fm.y*(val(aF.y,0,0,0))*area;\n   }"}) {
; _stencil_val(c,0,0,0);
...
int fractions_cleanup (scalar c, vector s,
         double smin, bool opposite) {tracing("fractions_cleanup","./../immersed.h",0);
...
schanged += changed;
  ...
  if (changed)
    fprintf (ferr, "WARNING: fractions_cleanup() did not converge after "
      "%d iterations\n", i);
  {end_tracing("fractions_cleanup","./../immersed.h",0);return schanged;}
end_tracing("fractions_cleanup","./../immersed.h",0);}
#line 4 "cylinderO.c"
#line 1 "curvature.h"
...
#line 643 "/home/spencer/basilisk/src/curvature.h"
  { cstats _ret= (cstats){sh, sf, sa, sc};delete((scalar*)((scalar[]){k,{-1}}));if((ch).x.i<=0)delete((scalar*)((vector[]){h,{{-1},{-1}}}));{end_tracing("curvature","/home/spencer/basilisk/src/curvature.h",0);return _ret;}}delete((scalar*)((scalar[]){k,{-1}}));
...
static double _boundary20(Point point,Point neighbor,scalar _s,void *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _neumann(0, point, neighbor, _s, data));}}}static double _boundary20_homogeneous(Point point,Point neighbor,scalar _s,void *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _neumann_homogeneous(0, point, neighbor, _s, data));}}}
static double _boundary21(Point point,Point neighbor,scalar _s,void *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _neumann(0, point, neighbor, _s, data));}}}static double _boundary21_homogeneous(Point point,Point neighbor,scalar _s,void *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _neumann_homogeneous(0, point, neighbor, _s, data));}}}
static double _boundary22(Point point,Point neighbor,scalar _s,void *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _neumann(0, point, neighbor, _s, data));}}}static double _boundary22_homogeneous(Point point,Point neighbor,scalar _s,void *data){int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;{int ig=neighbor.i-point.i;if(ig==0)ig=_attribute[_s.i].d.x;NOT_UNUSED(ig);int jg=neighbor.j-point.j;if(jg==0)jg=_attribute[_s.i].d.y;NOT_UNUSED(jg);POINT_VARIABLES;{return( _neumann_homogeneous(0, point, neighbor, _s, data));}}}
...
#line 51
      static int moving_cylinder(const int i,const double t,Event *_ev){tracing("moving_cylinder","cylinderO.c",0); {
  vc.x = A0*pulsation*sin(pulsation*t);
  do { scalar  phi=new_vertex_scalar("phi"); foreach_vertex_stencil(1,{(NonLocal[]){{"D","double",(void *)&D,NULL,0},{"vc","coord",(void *)&vc,NULL,0},{"dt","double",(void *)&dt,NULL,0},{"ci","coord",(void *)&ci,NULL,0},{"phi","scalar",(void *)&phi,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},""," \n// #line 53 \"cylinderO.c\"\nval_out_(phi,0,0,0) = - sq(x - ci.x - dt*vc.x) - sq(y - ci.y - dt*vc.y) + sq(D/2);"}) {_stencil_val_a(phi,0,0,0);               }end_foreach_vertex_stencil(); {foreach_vertex() val(phi,0,0,0) = - sq(x - ci.x - dt*vc.x) - sq(y - ci.y - dt*vc.y) + sq(D/2);end_foreach_vertex();} fractions (phi, airfoil, sf
#line 122 "/home/spencer/basilisk/src/fractions.h"
, 0.
#line 53 "cylinderO.c"
);delete((scalar*)((scalar[]){phi,{-1}})); } while(0);
}{end_tracing("moving_cylinder","cylinderO.c",0);return 0;}end_tracing("moving_cylinder","cylinderO.c",0);}

static int init_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t = 0)!=0;*ip=i;*tp=t;return ret;}


#line 56
      static int init_0(const int i,const double t,Event *_ev){tracing("init_0","cylinderO.c",0); {
  { {foreach_cell_post(!is_leaf(cell)) { if (is_leaf(cell)) { int bid = (y > 10*D ? top: y < -10*D ? bottom : -1); if (bid >= 0) cell.pid = - bid - 1; } else { int pid = -1; {foreach_child() if (cell.pid >= 0 || pid < 0) pid = cell.pid;end_foreach_child()} cell.pid = pid; if (pid < 0) { cell.flags |= leaf; decrement_neighbors (point); } } }end_foreach_cell_post();} ((Tree *)grid)->dirty = true; };

  foreach_stencil(1,{(NonLocal[]){{"u","vector",(void *)&u,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n    \n// #line 60 \"cylinderO.c\"\n{\n      val_out_(u.x,0,0,0) = 0.;\n      \n// #line 61\nval_out_(u.y,0,0,0) = 0.;}"})
    {
...
}{end_tracing("init_0","cylinderO.c",0);return 0;}end_tracing("init_0","cylinderO.c",0);}
...
#line 65
      static int properties_0(const int i,const double t,Event *_ev){tracing("properties_0","cylinderO.c",0); {
  if(!is_constant(fm.x)){
  
#line 66
foreach_face_stencil(1,{(NonLocal[]){{"D","double",(void *)&D,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 66 \"cylinderO.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(D)/(16.7);}end_is_face_x()\n// #line 66\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(D)/(16.7);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 66
foreach_face_generic(){is_face_x(){
    val(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(D)/(16.7);}end_is_face_x()
#line 66
is_face_y(){
    val(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(D)/(16.7);}end_is_face_y()}end_foreach_face_generic();}}else {_coord _const_fm={_constant[fm.x.i-_NVARMAX],_constant[fm.y.i-_NVARMAX]};NOT_UNUSED(_const_fm);
  
#line 66
foreach_face_stencil(1,{(NonLocal[]){{"D","double",(void *)&D,NULL,0},{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},"","\n// #line 66 \"cylinderO.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(D)/(16.7);}end_is_face_x()\n// #line 66\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(D)/(16.7);}end_is_face_y()}"}){_stencil_is_face_x(){
...
#line 66
foreach_face_generic(){is_face_x(){
    val(muv.x,0,0,0) = _const_fm.x*(U0)*(D)/(16.7);}end_is_face_x()
#line 66
is_face_y(){
    val(muv.y,0,0,0) = _const_fm.y*(U0)*(D)/(16.7);}end_is_face_y()}end_foreach_face_generic();}}
   boundary_internal ((scalar *)(scalar *)((vector[]) {muv,{{-1},{-1}}}), "cylinderO.c", 0);
}{end_tracing("properties_0","cylinderO.c",0);return 0;}end_tracing("properties_0","cylinderO.c",0);}
...
#line 72
      static int logfile(const int i,const double t,Event *_ev){tracing("logfile","cylinderO.c",0);{
  coord Fp = {0,0};
  immersed_force (airfoil, sf, &Fp);
  double CD = (Fp.x)/(0.5*sq(U0)*3.14159265358979*sq(D/2));
  double CL = (Fp.y)/(0.5*sq(U0)*3.14159265358979*sq(D/2));

  fprintf (ferr, "%d %g %d %d %d %d %g %g %g %g %g\n",
    i, t, mgp.i, mgp.nrelax, mgu.i, mgu.nrelax, CD, CL, vc.x, vc.y, dt);

}{end_tracing("logfile","cylinderO.c",0);return 0;}end_tracing("logfile","cylinderO.c",0);}

static int adapt_0_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(i++)!=0;*ip=i;*tp=t;return ret;}


#line 83
      static int adapt_0(const int i,const double t,Event *_ev){tracing("adapt_0","cylinderO.c",0); {
  adapt_wavelet (
#line 84 "/home/spencer/basilisk/src/grid/tree-common.h"
(
#line 173
scalar *
#line 84
...
}{end_tracing("adapt_0","cylinderO.c",0);return 0;}end_tracing("adapt_0","cylinderO.c",0);}

static int movie_expr0(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=( t <= t_end)!=0;*ip=i;*tp=t;return ret;}static int movie_expr1(int *ip,double *tp,Event *_ev){int i=*ip;double t=*tp;int ret=(t += 0.01)!=0;*ip=i;*tp=t;return ret;}
...
#line 12 "ast/init_solver.h"
{
      ...
      {  
#line 151 "/home/spencer/basilisk/src/axi.h"
event_register((Event){0,1,metric,{metric_expr0},((int *)0),((double *)0),"/home/spencer/basilisk/src/axi.h",0,"metric"});  
...
#line 51 "cylinderO.c"
event_register((Event){0,1,moving_cylinder,{moving_cylinder_expr0},((int *)0),((double *)0),"cylinderO.c",0,"moving_cylinder"});  




event_register((Event){0,1,init_0,{init_0_expr0},((int *)0),((double *)0),"cylinderO.c",0,"init"});  
#line 72
event_register((Event){0,1,logfile,{logfile_expr0},((int *)0),((double *)0),"cylinderO.c",0,"logfile"});  
#line 88
event_register((Event){0,2,movie,{movie_expr0,movie_expr1},((int *)0),((double *)0),"cylinderO.c",0,"movie"});
...
init_const_scalar((scalar){_NVARMAX+8},"unity0", 1.);  init_scalar((scalar){0},"p");  init_vector((vector){{1},{2}},"u");  init_vector((vector){{3},{4}},"g");  init_scalar((scalar){5},"pf");  init_face_vector((vector){{6},{7}},"uf");  init_vector((vector){{8},{9}},"aF");  init_scalar((scalar){10},"airfoil");  init_face_vector((vector){{11},{12}},"sf");  init_face_vector((vector){{13},{14}},"muv");
    
#line 23 "ast/init_solver.h"
}_attribute[p.i].dirty=1,_attribute[p.i].boundary[right]=_boundary4,_attribute[p.i].boundary_homogeneous[right]=_boundary4_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[left]=_boundary5,_attribute[p.i].boundary_homogeneous[left]=_boundary5_homogeneous;_attribute[uf.x.i].dirty=1,_attribute[uf.x.i].boundary[bottom]=_boundary6,_attribute[uf.x.i].boundary_homogeneous[bottom]=_boundary6;_attribute[uf.y.i].dirty=1,_attribute[uf.y.i].boundary[bottom]=_boundary7,_attribute[uf.y.i].boundary_homogeneous[bottom]=_boundary7_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[top]=_boundary8,_attribute[p.i].boundary_homogeneous[top]=_boundary8_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[left]=_boundary9,_attribute[u.x.i].boundary_homogeneous[left]=_boundary9_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[left]=_boundary10,_attribute[u.y.i].boundary_homogeneous[left]=_boundary10_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[left]=_boundary11,_attribute[p.i].boundary_homogeneous[left]=_boundary11_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[left]=_boundary12,_attribute[pf.i].boundary_homogeneous[left]=_boundary12_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[right]=_boundary13,_attribute[u.x.i].boundary_homogeneous[right]=_boundary13_homogeneous;_attribute[u.y.i].dirty=1,_attribute[u.y.i].boundary[right]=_boundary14,_attribute[u.y.i].boundary_homogeneous[right]=_boundary14_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[right]=_boundary15,_attribute[p.i].boundary_homogeneous[right]=_boundary15_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[right]=_boundary16,_attribute[pf.i].boundary_homogeneous[right]=_boundary16_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[top]=_boundary17,_attribute[u.x.i].boundary_homogeneous[top]=_boundary17_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[top]=_boundary18,_attribute[p.i].boundary_homogeneous[top]=_boundary18_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[top]=_boundary19,_attribute[pf.i].boundary_homogeneous[top]=_boundary19_homogeneous;_attribute[u.x.i].dirty=1,_attribute[u.x.i].boundary[bottom]=_boundary20,_attribute[u.x.i].boundary_homogeneous[bottom]=_boundary20_homogeneous;_attribute[p.i].dirty=1,_attribute[p.i].boundary[bottom]=_boundary21,_attribute[p.i].boundary_homogeneous[bottom]=_boundary21_homogeneous;_attribute[pf.i].dirty=1,_attribute[pf.i].boundary[bottom]=_boundary22,_attribute[pf.i].boundary_homogeneous[bottom]=_boundary22_homogeneous;  
...
#line 65 "cylinderO.c"
event_register((Event){0,1,properties_0,{properties_0_expr0},((int *)0),((double *)0),"cylinderO.c",0,"properties"});  
#line 83
event_register((Event){0,1,adapt_0,{adapt_0_expr0},((int *)0),((double *)0),"cylinderO.c",0,"adapt"});

...
plot 'cp1-guilmineau.dat' u 1:2 lc rgb "black" pt 4 t 'Guilmineau and Queutey (2002)', \
     ...
     'cp1-ni10.txt' u (abs($1-360)):b t "Present (N_i=10)" w l ls 1, \
     'cp1-ni5.txt' u (abs($1-360)):b t "Present (N_i=5)" w l ls 3, \
     'cp1-ni1.txt' u (abs($1-360)):b t "Present (N_i=1)" w l ls 4

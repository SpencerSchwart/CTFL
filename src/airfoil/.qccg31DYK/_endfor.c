...
is_face_y(){
 ...
 val(s.y,0,0,0) = 0.;}end_is_face_y()}end_foreach_face_generic();}
    ...
    changed = 0;
    foreach_stencil(1,{(NonLocal[]){{"changed","int",(void *)&changed,NULL,0,'+'},{"opposite","bool",(void *)&opposite,NULL,0},{"s","vector",(void *)&s,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n      \n// #line 315 \"/home/spencer/basilisk/src/embed.h\"\nif (val(c,0,0,0) > 0. && val(c,0,0,0) < 1.) {\n int n = 0;\n  {\n   for (int i = 0; i <= 1; i++)\n     if (val(s.x,i,0,0) > 0.)\n       n++;\n// # 330 \"/home/spencer/basilisk/src/embed.h\"\n   if (opposite && val(s.x,0,0,0) == 0. && val(s.x,1,0,0) == 0.)\n     val_out_(c,0,0,0) = 0., changed++;\n } \n// #line 317\n{\n   for (int i = 0; i <= 1; i++)\n     if (val(s.y,0,i,0) > 0.)\n       n++;\n// # 330 \"/home/spencer/basilisk/src/embed.h\"\n   if (opposite && val(s.y,0,0,0) == 0. && val(s.y,0,1,0) == 0.)\n     val_out_(c,0,0,0) = 0., changed++;\n }\n\n\n\n\n\n\n\n if (n < 2)\n   val_out_(c,0,0,0) = 0., changed++;\n      }")})
      {_stencil_val(c,0,0,0); _stencil_val(c,0,0,0); {   
...
F += val(flux.y,0,0,0) - val(flux.y,0,1,0);
 ...
 val(e,0,0,0) = (dt - dtmax)*F*_const_cm/scs;
  ...
  foreach_stencil(1,{(NonLocal[]){{"cs","scalar",(void *)&cs,NULL,0},{"f","scalar",(void *)&f,NULL,0},{"e","scalar",(void *)&e,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 876 \"/home/spencer/basilisk/src/embed.h\"\n{\n    real se = 0.;\n    {foreach_neighbor(1)\n      se += val(e,0,0,0);end_foreach_neighbor()}\n    val_out_(f,0,0,0) += val(cs,0,0,0)*se;\n  }")}) {   
...
if (!(constant (fm.y) == 1.)) qassert ("/home/spencer/basilisk/src/embed.h", 0, "constant (fm.x) == 1.");
  ...
  foreach_face_stencil(1,{(NonLocal[]){{"fs","vector",(void *)&fs,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 902 \"/home/spencer/basilisk/src/embed.h\"\n{is_face_x(){\n    val_out_(fs.x,0,0,0) = 1.;}end_is_face_x()\n// #line 902\nis_face_y(){\n    val_out_(fs.y,0,0,0) = 1.;}end_is_face_y()}")}){_stencil_is_face_x(){
...
is_face_y(){
  ...
  foreach_stencil(1,{(NonLocal[]){{"cs","scalar",(void *)&cs,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n    \n// #line 909 \"/home/spencer/basilisk/src/embed.h\"\nval_out_(cs,0,0,0) = 1.;")})
...
#line 17
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n    \n// #line 18 \"./../immersed.h\"\n{\n      val_out_(g.x,0,0,0) += val(fm.x,0,0,0)*val(aF.x,0,0,0);\n      \n// #line 19\nval_out_(g.y,0,0,0) += val(fm.y,0,0,0)*val(aF.y,0,0,0);}")})
    {
...
#line 17
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"g","vector",(void *)&g,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n    \n// #line 18 \"./../immersed.h\"\n{\n      val_out_(g.x,0,0,0) += _const_fm.x*val(aF.x,0,0,0);\n      \n// #line 19\nval_out_(g.y,0,0,0) += _const_fm.y*val(aF.y,0,0,0);}")})
    {
...
void interface_area_field (scalar c, scalar a) {
  foreach_stencil(1,{(NonLocal[]){{"a","scalar",(void *)&a,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n// # 382 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_length_center (coord m, real alpha, coord * p)\n{\n  alpha += (m.x + m.y)/2.;\n\n  coord n = m;\n  \n    if (n.x < 0.) {\n      alpha -= n.x;\n      n.x = - n.x;\n    }\n    \n// #line 388\nif (n.y < 0.) {\n      alpha -= n.y;\n      n.y = - n.y;\n    }\n\n  p->x = p->y = p->z = 0.;\n\n  if (alpha <= 0. || alpha >= n.x + n.y)\n    return 0.;\n\n  \n    if (n.x < 1e-4) {\n      p->x = 0.;\n      p->y = (m.y < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n    \n// #line 399\nif (n.y < 1e-4) {\n      p->y = 0.;\n      p->x = (m.x < 0. ? 1. - alpha : alpha) - 0.5;\n      return 1.;\n    }\n\n  if (alpha >= n.x) {\n    p->x += 1.;\n    p->y += (alpha - n.x)/n.y;\n  }\n  else\n    p->x += alpha/n.x;\n\n  real ax = p->x, ay = p->y;\n  if (alpha >= n.y) {\n    p->y += 1.;\n    ay -= 1.;\n    p->x += (alpha - n.y)/n.x;\n    ax -= (alpha - n.y)/n.x;\n  }\n  else {\n    p->y += alpha/n.y;\n    ay -= alpha/n.y;\n  }\n\n   {\n    p->x /= 2.;\n    p->x = clamp (p->x, 0., 1.);\n    if (m.x < 0.)\n      p->x = 1. - p->x;\n    p->x -= 0.5;\n  } \n// #line 424\n{\n    p->y /= 2.;\n    p->y = clamp (p->y, 0., 1.);\n    if (m.y < 0.)\n      p->y = 1. - p->y;\n    p->y -= 0.5;\n  }\n\n  return sqrt (ax*ax + ay*ay);\n}\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}"),_(" \n// #line 62 \"./../immersed.h\"\n{\n    if (val(c,0,0,0) > 0 && val(c,0,0,0) < 1) {\n      coord n = mycs (point, c), p;\n      real alpha = line_alpha (val(c,0,0,0), n);\n      val_out_(a,0,0,0) = pow(Delta, 2 - 1)*line_length_center(n,alpha,&p);\n    }\n  }")}) {
_stencil_val(c,0,0,0); _stencil_val(c,0,0,0); {   
       _stencil_mycs (point, c);     
      _stencil_val(c,0,0,0);
...
#line 74
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}"),_(" \n// #line 74 \"./../immersed.h\"\n{\n    coord nv;\n\n    coord n = facet_normal (point, c, fc), p;\n    real alpha = line_alpha (val(c,0,0,0), n);\n\n\n    real area = val(c,0,0,0)*pow(Delta,2);\n    \n      Fi.x += - val(fm.x,0,0,0)*(val(aF.x,0,0,0))*area;\n      \n// #line 83\nFi.y += - val(fm.y,0,0,0)*(val(aF.y,0,0,0))*area;\n   }")}) {    
...
#line 74
foreach_stencil(1,{(NonLocal[]){{"aF","vector",(void *)&aF,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"Fi","coord",(void *)&Fi,NULL,0},{"fc","vector",(void *)&fc,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_("\n// # 15 \"pitching-cpp.c\" 2\n// # 1 \"pitching.c\"\n// # 1 \"embed.h\" 1\n// # 1 \"/home/spencer/basilisk/src/embed.h\"\n// # 12 \"/home/spencer/basilisk/src/embed.h\"\n// # 1 \"fractions.h\" 1\n// # 1 \"/home/spencer/basilisk/src/fractions.h\"\n// # 12 \"/home/spencer/basilisk/src/fractions.h\"\n// # 1 \"geometry.h\" 1\n// # 1 \"/home/spencer/basilisk/src/geometry.h\"\n// # 35 \"/home/spencer/basilisk/src/geometry.h\"\nreal line_alpha (real c, coord n)\n{\n  real alpha, n1, n2;\n\n  n1 = fabs (n.x); n2 = fabs (n.y);\n  if (n1 > n2)\n    do { real __tmp = n1; n1 = n2; n2 = __tmp; } while(0);\n\n  c = clamp (c, 0., 1.);\n  real v1 = n1/2.;\n  if (c <= v1/n2)\n    alpha = sqrt (2.*c*n1*n2);\n  else if (c <= 1. - v1/n2)\n    alpha = c*n2 + v1;\n  else\n    alpha = n1 + n2 - sqrt (2.*n1*n2*(1. - c));\n\n  if (n.x < 0.)\n    alpha += n.x;\n  if (n.y < 0.)\n    alpha += n.y;\n\n  return alpha - (n.x + n.y)/2.;\n}\n// # 13 \"/home/spencer/basilisk/src/fractions.h\" 2\n\n\n\n\n\n// # 1 \"myc2d.h\" 1\n// # 1 \"/home/spencer/basilisk/src/myc2d.h\"\n\n\n\n\n\ncoord mycs (Point point, scalar c)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  int ix;\n  real c_t,c_b,c_r,c_l;\n  real mx0,my0,mx1,my1,mm1,mm2;\n\n\n  c_t = val(c,-1,1,0) + val(c,0,1,0) + val(c,1,1,0);\n  c_b = val(c,-1,-1,0) + val(c,0,-1,0) + val(c,1,-1,0);\n  c_r = val(c,1,-1,0) + val(c,1,0,0) + val(c,1,1,0);\n  c_l = val(c,-1,-1,0) + val(c,-1,0,0) + val(c,-1,1,0);\n\n\n\n  mx0 = 0.5*(c_l - c_r);\n  my0 = 0.5*(c_b - c_t);\n\n\n  if (fabs(mx0) <= fabs(my0)) {\n    my0 = my0 > 0. ? 1. : -1.;\n    ix = 1;\n  }\n  else {\n    mx0 = mx0 > 0. ? 1. : -1.;\n    ix = 0;\n  }\n\n\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,-1,0,0) + val(c,-1,1,0);\n  mm2 = val(c,1,-1,0) + 2.0*val(c,1,0,0) + val(c,1,1,0);\n  mx1 = mm1 - mm2 + 1e-30;\n  mm1 = val(c,-1,-1,0) + 2.0*val(c,0,-1,0) + val(c,1,-1,0);\n  mm2 = val(c,-1,1,0) + 2.0*val(c,0,1,0) + val(c,1,1,0);\n  my1 = mm1 - mm2 + 1e-30;\n\n\n  if (ix) {\n    mm1 = fabs(my1);\n    mm1 = fabs(mx1)/mm1;\n    if (mm1 > fabs(mx0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n  else {\n    mm1 = fabs(mx1);\n    mm1 = fabs(my1)/mm1;\n    if (mm1 > fabs(my0)) {\n      mx0 = mx1;\n      my0 = my1;\n    }\n  }\n\n\n\n  mm1 = fabs(mx0) + fabs(my0);\n  coord n = {mx0/mm1, my0/mm1};\n\n  return n;\n}\n\n\n\n\n\n\n// #line 418 \"/home/spencer/basilisk/src/fractions.h\"\ncoord facet_normal (Point point, scalar c, vector s)\n{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;\n  if (s.x.i >= 0) {\n    coord n;\n    real nn = 0.;\n     {\n      n.x = val(s.x,0,0,0) - val(s.x,1,0,0);\n      nn += fabs(n.x);\n    } \n// #line 423\n{\n      n.y = val(s.y,0,0,0) - val(s.y,0,1,0);\n      nn += fabs(n.y);\n    }\n    if (nn > 0.)\n      {\n n.x /= nn;\n \n// #line 429\nn.y /= nn;}\n    else\n      {\n n.x = 1./2;\n \n// #line 432\nn.y = 1./2;}\n    return n;\n  }\n  return mycs (point, c);\n}"),_(" \n// #line 74 \"./../immersed.h\"\n{\n    coord nv;\n\n    coord n = facet_normal (point, c, fc), p;\n    real alpha = line_alpha (val(c,0,0,0), n);\n\n\n    real area = val(c,0,0,0)*pow(Delta,2);\n    \n      Fi.x += - _const_fm.x*(val(aF.x,0,0,0))*area;\n      \n// #line 83\nFi.y += - _const_fm.y*(val(aF.y,0,0,0))*area;\n   }")}) {    
...
void boundary_cells (scalar c, scalar ink) {
  ...
  foreach_stencil(1,{(NonLocal[]){{"phi","scalar",(void *)&phi,NULL,0},{"c","scalar",(void *)&c,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_(" \n// #line 8 \"./../interfaceforce.h\"\n{\n    if(val(c,0,0,0) > 1e-6 && val(c,0,0,0) < 1. - 1e-6)\n      val_out_(phi,0,0,0) = 1.;\n    else\n      val_out_(phi,0,0,0) = -1.;\n  }")}) {
_stencil_val(c,0,0,0); _stencil_val(c,0,0,0);{
...
# 289 "/home/spencer/basilisk/src/heights.h"
...
{int ig=0;NOT_UNUSED(ig);int jg=0;NOT_UNUSED(jg);POINT_VARIABLES;
 ...
 val(h,0,0,0) = val(h,i,0,0) + i;
  ...
  if (complete)
    return;
# 317 "/home/spencer/basilisk/src/heights.h"
...
# 352 "/home/spencer/basilisk/src/heights.h"
}
...
# 399 "/home/spencer/basilisk/src/heights.h"
      {foreach_level (l - 1)
 { {
...
# 1 "utils.h" 1
# 2 "/home/spencer/basilisk/src/parabola.h" 2
...
#line 174
foreach_face_stencil(1,{(NonLocal[]){{"U0","double",(void *)&U0,NULL,0},{"fm","vector",(void *)&fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 174 \"pitching.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = val(fm.x,0,0,0)*(U0)*(1)/((10000.));}end_is_face_x()\n// #line 174\nis_face_y(){\n    val_out_(muv.y,0,0,0) = val(fm.y,0,0,0)*(U0)*(1)/((10000.));}end_is_face_y()}")}){_stencil_is_face_x(){
...
#line 174
foreach_face_stencil(1,{(NonLocal[]){{"U0","double",(void *)&U0,NULL,0},{"_const_fm","_coord",(void *)&_const_fm,NULL,0},{"muv","vector",(void *)&muv,NULL,0},{"N","int",(void *)&N,NULL,0},{"L0","double",(void *)&L0,NULL,0},{"Z0","double",(void *)&Z0,NULL,0},{"Y0","double",(void *)&Y0,NULL,0},{"X0","double",(void *)&X0,NULL,0},{0}},_(""),_("\n// #line 174 \"pitching.c\"\n{is_face_x(){\n    val_out_(muv.x,0,0,0) = _const_fm.x*(U0)*(1)/((10000.));}end_is_face_x()\n// #line 174\nis_face_y(){\n    val_out_(muv.y,0,0,0) = _const_fm.y*(U0)*(1)/((10000.));}end_is_face_y()}")}){_stencil_is_face_x(){
